...
This package contains the source for the Niji webapp at [nouns.wtf](https://nouns.wtf).
...
Select the network and connect to your local Niji webapp to interact with simnet
