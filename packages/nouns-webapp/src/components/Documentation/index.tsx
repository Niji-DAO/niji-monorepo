      ...
      <Col lg={{ span: 10, offset: 1 }}>
        <div className={classes.headerWrapper}>
          ...
          <p className={classes.aboutText}>
            <Trans>
              Niji are an experimental attempt to improve the formation of on-chain avatar
              communities. While projects such as {cryptopunksLink} have attempted to bootstrap
              digital community and identity, Niji attempt to bootstrap identity, community,
              governance, and a treasury that can be used by the community.
            </Trans>
          </p>
          <p className={classes.aboutText} style={{ paddingBottom: '4rem' }}>
            <Trans>
              Learn more below, or start creating Niji off-chain using the {playgroundLink}.
            </Trans>
          </p>
        </div>
        <Accordion flush>
          <Accordion.Item eventKey="0" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <ul>
                ...
                <li>
                  <Trans>All Niji are members of Niji DAO.</Trans>
                </li>
                <li>
                ...
                <li>
                  <Trans>The treasury is controlled exclusively by Niji via governance.</Trans>
                </li>
                <li>
                ...
                <li>
                  <Trans>
                    No explicit rules exist for attribute scarcity; all Niji are equally rare.
                  </Trans>
                </li>
                <li>
                  <Trans>
                    Nounders receive rewards in the form of Niji (10% of supply for first 5 years).
                  </Trans>
                </li>
              </ul>
            </Accordion.Body>
            ...
            <Accordion.Body>
              ...
              <p>
                <Trans>
                  ...
                  triggered by anyone, allowing the system to trustlessly auction Niji as long as
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  ...
                  believed that a healthy distribution of Niji would be sufficient protection for
              ...
              <ul>
                ...
                <li>
                  attempt to alter Niji auction cadence for the purpose of maintaining or acquiring
                  a voting majority
                </li>
          ...
          <Accordion.Item eventKey="4" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  Niji are generated randomly based Ethereum block hashes. There are no 'if'
                  statements or other rules governing Niji trait scarcity, which makes all Niji
                  equally rare. As of this writing, Niji are made up of:
                </Trans>
              </p>
              <ul>
                <li>
          ...
          <Accordion.Item eventKey="5" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  Niji are stored directly on Ethereum and do not utilize pointers to other networks
                  such as IPFS. This is possible because Niji parts are compressed and stored
          ...
          <Accordion.Item eventKey="7" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p>
                <Trans>
                  'Nounders' are the group of ten builders that initiated Niji. Here are the
                  Nounders:
                </Trans>
              </p>
              <ul>
              ...
              <p>
                <Trans>
                  ...
                  to compensate themselves with Niji. Every 10th Niji for the first 5 years of the
              ...
              <p>
                <Trans>
                  Nounder distributions don't interfere with the cadence of 24 hour auctions. Niji
                  are sent directly to the Nounder's Multisig, and auctions continue on schedule
                  with the next available Niji ID.
                </Trans>
              </p>
            </Accordion.Body>
          </Accordion.Item>
