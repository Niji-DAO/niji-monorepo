...
// Wrapper type around Niji events.
...
/**
 * Fetch list of ProposalVoteEvents representing the voting history of the given Niji
 * @param nounId Id of Niji who's voting history will be fetched
 */
const useNounProposalVoteEvents = (nounId: number): NounProfileEventFetcherResponse => {
  ...
  const filteredProposals = proposals.filter((p: PartialProposal, id: number) => {
    ...
    // Filter props from before the Niji was born
...
/**
 * Fetch list of TransferEvents for given Niji
 * @param nounId Id of Niji who's transfer history we will fetch
 */
...
/**
 * Fetch list of DelegationEvents for given Niji
 * @param nounId Id of Niji who's transfer history we will fetch
 */
...
/**
 * Fetch list of all events for given Niji (ex: voting, transfer, delegation, etc.)
 * @param nounId Id of Niji who's history we will fetch
 */
