...
```ts
import { ImageData } from '@niji/assets';
...
```ts
import { getNounData } from '@niji/assets';
...
```ts
import { getNounSeedFromBlockHash } from '@niji/assets';
...
import { ImageData, getNounSeedFromBlockHash, getNounData } from '@niji/assets';
