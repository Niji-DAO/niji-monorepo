...
import { IForkDAODeployer, INijiDAOForkEscrow } from '../../../contracts/governance/NijiDAOInterfaces.sol';
...
contract ForkDAODeployerMock is IForkDAODeployer, StdCheats {
    ...
    function deployForkDAO(uint256, INijiDAOForkEscrow) external view returns (address treasury, address token) {
