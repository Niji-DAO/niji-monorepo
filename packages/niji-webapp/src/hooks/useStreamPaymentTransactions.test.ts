...
describe('useStreamPaymentTransactions', () => {
  ...
  it('round-8 30 sequential useStreamPaymentTransactions access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useStreamPaymentTransactions).toBeDefined();
    }
  });
  ...
  it('round-9 30 sequential useStreamPaymentTransactions access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useStreamPaymentTransactions).toBeDefined();
    }
  });
  ...
  it('round-9 50 sequential truthy checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(useStreamPaymentTransactions).toBeTruthy();
    }
  });
  ...
  it('round-10 30 sequential useStreamPaymentTransactions truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useStreamPaymentTransactions).toBeTruthy();
    }
  });
  ...
  it('round-11 30 sequential useStreamPaymentTransactions truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useStreamPaymentTransactions).toBeTruthy();
    }
  });
