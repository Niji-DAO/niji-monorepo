...
describe('useProposalStatus', () => {
  ...
  it('round-7 30 sequential useProposalStatus access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalStatus).toBeDefined();
    }
  });
  ...
  it('round-9 30 sequential useProposalStatus access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalStatus).toBeDefined();
    }
  });
  ...
  it('round-11 30 sequential useProposalStatus truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalStatus).toBeTruthy();
    }
  });
