...
describe('useScrollToLocation', () => {
  ...
  it('round-4 30 renderHook cycles useScrollToLocation', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useScrollToLocation());
      unmount();
    }
  ...
  it('round-5 30 renderHook cycles useScrollToLocation', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useScrollToLocation());
      unmount();
    }
  ...
  it('round-6 30 renderHook cycles useScrollToLocation', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useScrollToLocation());
      unmount();
    }
  ...
  it('round-6 50 renderHook cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = renderHook(() => useScrollToLocation());
      unmount();
    }
  ...
  it('round-8 50 renderHook cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = renderHook(() => useScrollToLocation());
      unmount();
    }
  ...
  it('round-10 30 sequential useScrollToLocation truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useScrollToLocation).toBeTruthy();
    }
  });
