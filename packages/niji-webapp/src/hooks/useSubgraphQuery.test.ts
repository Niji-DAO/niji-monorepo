...
describe('useSubgraphQuery', () => {
  ...
  it('round-3 30 renderHook cycles useSubgraphQuery', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useSubgraphQuery({} as never));
      unmount();
    }
  ...
  it('round-4 30 renderHook cycles useSubgraphQuery', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useSubgraphQuery({} as never));
      unmount();
    }
  ...
  it('round-4 50 renderHook cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = renderHook(() => useSubgraphQuery({} as never));
      unmount();
    }
  ...
  it('round-5 30 renderHook cycles useSubgraphQuery', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useSubgraphQuery({} as never));
      unmount();
    }
  ...
  it('round-5 50 renderHook cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = renderHook(() => useSubgraphQuery({} as never));
      unmount();
    }
  ...
  it('round-7 30 sequential useSubgraphQuery access', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-8 30 sequential useSubgraphQuery access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useSubgraphQuery).toBeDefined();
    }
  });
  ...
  it('round-10 30 sequential useSubgraphQuery truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useSubgraphQuery).toBeTruthy();
    }
  });
  ...
  it('round-11 30 sequential useSubgraphQuery truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useSubgraphQuery).toBeTruthy();
    }
  });
