...
describe('countDecimals', () => {
  ...
  it('round-7 30 sequential countDecimals calls', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => countDecimals(i + 17000)).not.toThrow();
    }
  });

  it('round-7 50 sequential calls produce number', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof countDecimals(i + 18000)).toBe('number');
    }
  });
  ...
  it('round-7 100 sequential alternating int / float', () => {
    for (let i = 0; i < 100; i++) {
      const n = i % 2 === 0 ? i + 21000 : i + 21000.625;
      expect(typeof countDecimals(n)).toBe('number');
    }
  });
  ...
  it('round-11 30 sequential countDecimals truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(countDecimals).toBeTruthy();
    }
  });
  ...
  it('round-11 50 sequential return type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof countDecimals(i + 59000.25)).toBe('number');
    }
  });

  it('round-11 100 mixed argument variation', () => {
    for (let i = 0; i < 100; i++) {
      const n = i % 3 === 0 ? i + 69000 : i % 3 === 1 ? i + 69000.5 : i + 69000.125;
      expect(typeof countDecimals(n)).toBe('number');
    }
  });
