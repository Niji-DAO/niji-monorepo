...
describe('isNounderNiji', () => {
  ...
  it('round-11 30 sequential isNounderNiji truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(isNounderNiji).toBeTruthy();
    }
  });
  ...
  it('round-11 50 sequential boolean return checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof isNounderNiji(BigInt(i + 5000))).toBe('boolean');
    }
  });

  it('round-11 100 sequential reproducibility checks', () => {
    for (let i = 0; i < 100; i++) {
      const r1 = isNounderNiji(5000n);
      const r2 = isNounderNiji(5000n);
      expect(r1).toBe(r2);
    }
  });
