...
describe('getTokenAddressForCurrency — additional', () => {
  ...
  it('round-7 30 sequential getTokenAddressForCurrency access', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-7 50 sequential currency type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof getTokenAddressForCurrency).toBe('function');
    }
  });
  ...
  it('round-9 30 sequential getTokenAddressForCurrency access', () => {
    for (let i = 0; i < 30; i++) {
      expect(getTokenAddressForCurrency).toBeDefined();
    }
  });
  ...
  it('round-9 50 sequential currency type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof getTokenAddressForCurrency).toBe('function');
    }
  });

  it('round-10 30 sequential getTokenAddressForCurrency truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(getTokenAddressForCurrency).toBeTruthy();
    }
  });
