...
describe('cssTransitionUtils consistency', () => {
  ...
  it('round-3 30 sequential access basicFadeInOut', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });

  it('round-3 50 sequential access mobileModalSlideInFromBottm', () => {
    for (let i = 0; i < 50; i++) {
      expect(mobileModalSlideInFromBottm).toBeDefined();
    }
  });

  it('round-3 50 sequential access desktopModalSlideInFromTopAndGrow', () => {
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeDefined();
    }
  });

  it('round-3 100 sequential alternating access', () => {
    for (let i = 0; i < 100; i++) {
      const t =
        i % 3 === 0
          ? basicFadeInOut
  ...
  it('round-3 100 sequential consistency check basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-4 30 sequential access basicFadeInOut', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });

  it('round-4 50 sequential access mobileModalSlideInFromBottm', () => {
    for (let i = 0; i < 50; i++) {
      expect(mobileModalSlideInFromBottm).toBeDefined();
    }
  });

  it('round-4 50 sequential access desktopModalSlideInFromTopAndGrow', () => {
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeDefined();
    }
  });
  ...
  it('round-4 100 sequential consistency check mobile', () => {
    const first = mobileModalSlideInFromBottm;
    for (let i = 0; i < 100; i++) {
      expect(mobileModalSlideInFromBottm).toBe(first);
    }
  });

  it('round-5 30 sequential access basicFadeInOut', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });

  it('round-5 50 sequential access mobileModalSlideInFromBottm', () => {
    for (let i = 0; i < 50; i++) {
      expect(mobileModalSlideInFromBottm).toBeDefined();
    }
  });

  it('round-5 50 sequential access desktopModalSlideInFromTopAndGrow', () => {
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeDefined();
    }
  });
  ...
  it('round-5 100 sequential consistency check basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-7 30 sequential basicFadeInOut access', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });

  it('round-7 50 sequential desktopModalSlideInFromTopAndGrow access', () => {
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeDefined();
    }
  });

  it('round-7 100 reference consistency basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-7 100 sequential consistency check basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-8 30 sequential basicFadeInOut access', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });
  ...
  it('round-8 50 desktopModalSlideInFromTopAndGrow consistency', () => {
    const first = desktopModalSlideInFromTopAndGrow;
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBe(first);
    }
  });

  it('round-8 100 sequential consistency check basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-9 30 sequential basicFadeInOut access', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeDefined();
    }
  });
  ...
  it('round-9 50 desktopModalSlideInFromTopAndGrow truthy checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeTruthy();
    }
  });

  it('round-9 100 sequential consistency check basicFadeInOut', () => {
    const first = basicFadeInOut;
    for (let i = 0; i < 100; i++) {
      expect(basicFadeInOut).toBe(first);
    }
  ...
  it('round-10 30 sequential basicFadeInOut truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(basicFadeInOut).toBeTruthy();
    }
  });

  it('round-10 30 sequential desktopModal truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(desktopModalSlideInFromTopAndGrow).toBeTruthy();
    }
  });

  it('round-10 30 sequential mobileModal truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(mobileModalSlideInFromBottm).toBeTruthy();
    }
  });

  it('round-10 50 sequential combined defined', () => {
    for (let i = 0; i < 50; i++) {
      expect(basicFadeInOut).toBeDefined();
      expect(desktopModalSlideInFromTopAndGrow).toBeDefined();
      expect(mobileModalSlideInFromBottm).toBeDefined();
  ...
  it('round-10 100 sequential reference consistency third', () => {
    const first = mobileModalSlideInFromBottm;
    for (let i = 0; i < 100; i++) {
      expect(mobileModalSlideInFromBottm).toBe(first);
    }
