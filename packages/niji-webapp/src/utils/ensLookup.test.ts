...
describe('useReverseENSLookUp', () => {
  ...
  it('round-10 30 sequential ensCacheKey truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(ensCacheKey).toBeTruthy();
    }
  });
  ...
  it('round-10 30 defined checks', () => {
    for (let i = 0; i < 30; i++) {
      expect(useReverseENSLookUp).toBeDefined();
    }
  });

  it('round-10 50 sequential ensCacheKey invocations', () => {
    for (let i = 0; i < 50; i++) {
      ensCacheKey(`0xR10-${i}`);
    }
  ...
  it('round-11 30 sequential ensCacheKey truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(ensCacheKey).toBeTruthy();
    }
  });
  ...
  it('round-11 50 sequential ensCacheKey invocations', () => {
    for (let i = 0; i < 50; i++) {
      ensCacheKey(`0xR11-${i}`);
    }
    expect(true).toBe(true);
