...
import { nijiTokenBuyerAddress } from '@niji/sdk/react';
      ...
      <Col lg={{ span: 8, offset: 2 }} className={classes.createProposalForm}>
        ...
        <Alert variant="secondary" className={classes.voterIneligibleAlert}>
          <Trans>
            ...
            by Nijis voters, it can be promoted to a proposal.{' '}
          </Trans>
          <br />
          <br />
          ...
          <strong>
            <Trans>
              Submissions are free for Nijis voters. Non-voters can submit for a{' '}
