...
describe('BrandTextEntry', () => {
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BrandTextEntry value="r6" onChange={() => {}} />);
      unmount();
    }
  });
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandTextEntry key={i} value={`r6-${i}`} onChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 rapid 200 onChange events', () => {
    const onChange = vi.fn();
    const { container } = render(<BrandTextEntry value="x" onChange={onChange} />);
    const input = container.querySelector('input')!;
    for (let i = 0; i < 200; i++) {
      fireEvent.change(input, { target: { value: `r6-${i}` } });
    }
    expect(onChange).toHaveBeenCalledTimes(200);
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandTextEntry key={i} value={`r7-${i}`} onChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 rapid 200 onChange events', () => {
    const onChange = vi.fn();
    const { container } = render(<BrandTextEntry value="x" onChange={onChange} />);
    const input = container.querySelector('input')!;
    for (let i = 0; i < 200; i++) {
      fireEvent.change(input, { target: { value: `r7-${i}` } });
    }
    expect(onChange).toHaveBeenCalledTimes(200);
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandTextEntry key={i} value={`r9-${i}`} onChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 rapid 200 onChange events', () => {
    const onChange = vi.fn();
    const { container } = render(<BrandTextEntry value="x" onChange={onChange} />);
    const input = container.querySelector('input')!;
    for (let i = 0; i < 200; i++) {
      fireEvent.change(input, { target: { value: `r9-${i}` } });
    }
    expect(onChange).toHaveBeenCalledTimes(200);
  });

  it('round-10 30 sequential BrandTextEntry mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BrandTextEntry placeholder={`r10-${i}`} onChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-10 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandTextEntry key={i} placeholder={`r10-i-${i}`} onChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<BrandTextEntry placeholder={`r10-s-${i}`} onChange={() => {}} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<BrandTextEntry placeholder={`r10-m-${i}`} onChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential onChange invocations', () => {
    const cb = vi.fn();
    const { container } = render(<BrandTextEntry placeholder="r10-c" onChange={cb} />);
    const input = container.querySelector('input') as HTMLInputElement;
    for (let i = 0; i < 100; i++) {
      fireEvent.change(input, { target: { value: `r10-${i}` } });
    }
  ...
  it('round-12 30 sequential BrandTextEntry mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BrandTextEntry placeholder={`r12-m-${i}`} onChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-12 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandTextEntry key={i} placeholder={`r12-i-${i}`} onChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-12 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<BrandTextEntry placeholder={`r12-s-${i}`} onChange={() => {}} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-12 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <BrandTextEntry placeholder={`r12-m2-${i}`} onChange={() => {}} />,
      );
      unmount();
    }
  });
  ...
  it('round-12 100 sequential onChange invocations', () => {
    const cb = vi.fn();
    const { container } = render(<BrandTextEntry placeholder="r12-c" onChange={cb} />);
    const input = container.querySelector('input') as HTMLInputElement;
    for (let i = 0; i < 100; i++) {
      fireEvent.change(input, { target: { value: `r12-${i}` } });
    }
    expect(cb).toHaveBeenCalledTimes(100);
  });
});
