...
describe('CreateCandidateButton', () => {
  ...
  it('handles rapid 30 isLoading toggle rerender', () => {
    const { rerender } = render(
      <CreateCandidateButton
        isLoading={false}
        hasActiveOrPendingProposal={false}
  ...
  it('round-2 handles 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-2 handles 30 isFormInvalid toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-4 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-5 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-6 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-7 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-8 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-9 30 isLoading toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          handleCreateProposal={() => {}}
  ...
  it('round-10 30 sequential CreateCandidateButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateCandidateButton
          isLoading={false}
