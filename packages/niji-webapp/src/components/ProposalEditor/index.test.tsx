...
describe('ProposalEditor', () => {
  ...
  it('round-6 30 isCandidate toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} isCandidate={i % 2 === 0} />);
      unmount();
    }
  ...
  it('round-7 30 isCandidate toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} isCandidate={i % 2 === 0} />);
      unmount();
    }
  ...
  it('round-8 30 isCandidate toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} isCandidate={i % 2 === 0} />);
      unmount();
    }
  ...
  it('round-9 30 isCandidate toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} isCandidate={i % 2 === 0} />);
      unmount();
    }
  ...
  it('round-10 30 sequential ProposalEditor mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} />);
      unmount();
    }
  ...
  it('round-10 100 sequential isCandidate alternating', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<ProposalEditor {...defaults} isCandidate={i % 2 === 0} />);
      unmount();
    }
