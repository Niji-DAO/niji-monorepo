...
describe('FunctionCallEnterArgsStep', () => {
  ...
  it('round-4 30 sequential state mutations second', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-5 30 sequential state mutations second', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-6 30 sequential state mutations second', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-7 30 sequential state mutations second', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-8 30 sequential state mutations second', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-10 30 sequential FunctionCallEnterArgsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
  ...
  it('round-12 30 sequential FunctionCallEnterArgsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <FunctionCallEnterArgsStep {...defaults} state={{ abi, function: 'transfer' } as never} />,
      );
