...
describe('StreamPaymentsPaymentDetailsStep', () => {
  ...
  it('round-233 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-234 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-235 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-236 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-237 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-238 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-239 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-240 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-241 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-242 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-243 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-244 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-245 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-246 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-247 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-248 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-249 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-250 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-251 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-252 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-253 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-254 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-255 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-256 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-257 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-258 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-259 30 sequential StreamPaymentsPaymentDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentsPaymentDetailsStep {...defaults} />);
      unmount();
    }
