...
describe('StreamPaymentDateDetailsStep', () => {
  ...
  it('round-7 30 sequential streamStartTimestamp values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <StreamPaymentDateDetailsStep
          {...defaults}
          state={{ ...defaults.state, streamStartTimestamp: 5000000000 + i * 7200 } as never}
        />,
      );
      unmount();
    }
  ...
  it('round-8 30 different streamStartTimestamp cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <StreamPaymentDateDetailsStep
          {...defaults}
          state={{ ...defaults.state, streamStartTimestamp: 6000000000 + i * 7200 } as never}
        />,
      );
      unmount();
    }
  ...
  it('round-10 30 sequential StreamPaymentDateDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentDateDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-11 30 sequential StreamPaymentDateDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentDateDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-12 30 sequential StreamPaymentDateDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<StreamPaymentDateDetailsStep {...defaults} />);
      unmount();
    }
