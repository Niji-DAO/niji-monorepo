...
describe('SelectProposalActionStep', () => {
  ...
  it('round-213 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-214 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-215 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-216 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-217 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-218 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-219 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-220 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-221 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-222 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-223 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-224 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-225 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-226 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-227 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-228 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-229 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-230 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-231 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-232 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-233 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-234 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-235 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-236 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-237 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-238 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-239 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-240 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-241 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-242 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-243 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-244 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-245 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-246 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-247 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-248 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-249 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-250 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-252 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-253 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-254 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-255 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-256 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-257 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-258 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
  ...
  it('round-259 30 sequential SelectProposalActionStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectProposalActionStep {...setupProps()} />);
      unmount();
    }
