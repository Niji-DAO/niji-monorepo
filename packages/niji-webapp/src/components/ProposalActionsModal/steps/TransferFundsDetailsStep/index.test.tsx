...
describe('TransferFundsDetailsStep', () => {
  ...
  it('round-10 30 sequential TransferFundsDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TransferFundsDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-11 30 sequential TransferFundsDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TransferFundsDetailsStep {...defaults} />);
      unmount();
    }
  ...
  it('round-12 30 sequential TransferFundsDetailsStep mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TransferFundsDetailsStep {...defaults} />);
      unmount();
    }
