...
describe('VoteStatusPill', () => {
  ...
  it('round-4 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text="r4" />);
      unmount();
    }
  });
  ...
  it('round-4 renders 1000 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 1000 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r4-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 100 different text values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text={`r4-text-${i}`} />);
      unmount();
    }
  });

  it('round-4 all 200 instances render div root', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <VoteStatusPill key={i} status="success" text={`r4-${i}`} />
  ...
  it('round-4 100 status transitions', () => {
    const statuses = ['success', 'failure', 'pending', 'unknown'];
    const { rerender } = render(<VoteStatusPill status="success" text="x" />);
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r4-${i}`} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text="r6" />);
      unmount();
    }
  });
  ...
  it('round-6 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r6-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 100 status transitions', () => {
    const statuses = ['success', 'failure', 'pending', 'unknown'];
    const { rerender } = render(<VoteStatusPill status="success" text="x" />);
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r6-${i}`} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text="r7" />);
      unmount();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r7-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<VoteStatusPill status="success" text="r7" />)).not.toThrow();
    }
  });
  ...
  it('round-7 100 status transitions', () => {
    const statuses = ['success', 'failure', 'pending', 'unknown'];
    const { rerender } = render(<VoteStatusPill status="success" text="x" />);
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r7-${i}`} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-8 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text="r8" />);
      unmount();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r8-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<VoteStatusPill status="success" text="r8" />)).not.toThrow();
    }
  });
  ...
  it('round-8 100 status transitions', () => {
    const statuses = ['success', 'failure', 'pending', 'unknown'];
    const { rerender } = render(<VoteStatusPill status="success" text="x" />);
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r8-${i}`} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteStatusPill status="success" text="r9" />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r9-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<VoteStatusPill status="success" text="r9" />)).not.toThrow();
    }
  });
  ...
  it('round-9 100 status transitions', () => {
    const statuses = ['success', 'failure', 'pending', 'unknown'];
    const { rerender } = render(<VoteStatusPill status="success" text="x" />);
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r9-${i}`} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-11 30 sequential VoteStatusPill mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteStatusPill status="pending" text={`r11-m-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <VoteStatusPill key={i} status="success" text={`r11-i-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<VoteStatusPill status="success" text={`r11-s-${i}`} />)).not.toThrow();
    }
  });

  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<VoteStatusPill status="failure" text={`r11-m2-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-11 100 sequential rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<VoteStatusPill status={statuses[i % 4]} text={`r11-${i}`} />),
      ).not.toThrow();
    }
  });
});
