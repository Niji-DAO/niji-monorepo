...
describe('SelectSponsorsToPropose', () => {
  ...
  it('round-10 30 sequential SelectSponsorsToPropose mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-10 100 sequential alternating isModalOpen', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <SelectSponsorsToPropose {...baseProps} isModalOpen={i % 2 === 0} />,
      );
  ...
  it('round-11 30 sequential SelectSponsorsToPropose mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SelectSponsorsToPropose {...baseProps} />);
      unmount();
    }
  ...
  it('round-11 100 sequential alternating isModalOpen', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <SelectSponsorsToPropose {...baseProps} isModalOpen={i % 2 === 0} />,
      );
