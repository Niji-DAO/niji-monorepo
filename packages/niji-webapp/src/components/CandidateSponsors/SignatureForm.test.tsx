...
describe('SignatureForm', () => {
  ...
  it('round-3 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<SignatureForm {...baseProps} />)).not.toThrow();
    }
  });
  ...
  it('round-3 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 100} />);
      unmount();
    }
  });
  ...
  it('round-4 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 500} />);
      unmount();
    }
  });
  ...
  it('round-5 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <SignatureForm key={i} {...baseProps} proposalIdToUpdate={i + 5000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 7000} />);
      unmount();
    }
  });
  ...
  it('round-6 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 9000} />);
      unmount();
    }
  });
  ...
  it('round-7 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 11000} />);
      unmount();
    }
  });
  ...
  it('round-8 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 13000} />);
      unmount();
    }
  });
  ...
  it('round-9 30 different proposalIdToUpdate cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 15000} />);
      unmount();
    }
  });

  it('round-10 30 sequential SignatureForm mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} />);
      unmount();
    }
  ...
  it('round-10 100 sequential different proposalIdToUpdate values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 40000} />);
      unmount();
    }
  });

  it('round-11 30 sequential SignatureForm mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 50000} />);
      unmount();
    }
  });
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <SignatureForm key={i} {...baseProps} proposalIdToUpdate={i + 60000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 70000} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 80000} />);
      unmount();
    }
  });

  it('round-11 100 sequential different proposalIdToUpdate values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<SignatureForm {...baseProps} proposalIdToUpdate={i + 90000} />);
      unmount();
    }
  });
