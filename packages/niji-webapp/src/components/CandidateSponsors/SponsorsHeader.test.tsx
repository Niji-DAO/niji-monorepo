...
describe('SponsorsHeader (update flow)', () => {
  ...
  it('round-7 30 isThresholdMet toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SponsorsHeader candidate={baseCandidate} isThresholdMet={i % 2 === 0} />,
      );
  ...
  it('round-8 30 isThresholdMet toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SponsorsHeader candidate={baseCandidate} isThresholdMet={i % 2 === 0} />,
      );
  ...
  it('round-9 30 isThresholdMet toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SponsorsHeader candidate={baseCandidate} isThresholdMet={i % 2 === 0} />,
      );
  ...
  it('round-10 30 sequential SponsorsHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SponsorsHeader candidate={baseCandidate} isThresholdMet={false} />,
      );
  ...
  it('round-10 100 sequential alternating isThresholdMet', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <SponsorsHeader candidate={baseCandidate} isThresholdMet={i % 2 === 0} />,
      );
