...
describe('HorizontalStackedNijis', () => {
  ...
  it('round-4 renders 200 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 200 }, (_, i) => (
            <HorizontalStackedNijis key={i} nounIds={[`${i + 500}`]} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 30 different nounIds arrays', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<HorizontalStackedNijis nounIds={[`${i + 1000}`]} />);
      unmount();
    }
  });

  it('round-4 30 arrays of various sizes', () => {
    for (let i = 1; i <= 30; i++) {
      const ids = Array.from({ length: i }, (_, j) => `${j + 200}`);
      const { unmount } = render(<HorizontalStackedNijis nounIds={ids} />);
      unmount();
    }
  });
  ...
  it('round-4 100 rerender cycles', () => {
    const { rerender } = render(<HorizontalStackedNijis nounIds={['1']} />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<HorizontalStackedNijis nounIds={[`${i + 500}`]} />)).not.toThrow();
    }
  });

  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<HorizontalStackedNijis nounIds={['1', '2', '3']} />);
      unmount();
    }
  });
  ...
  it('round-5 30 different nounIds arrays', () => {
    for (let i = 0; i < 30; i++) {
      ...
      const { unmount } = render(<HorizontalStackedNijis nounIds={nounIds} />);
      unmount();
    }
  });
  ...
  it('round-5 100 rerender cycles', () => {
    const { rerender } = render(<HorizontalStackedNijis nounIds={['1']} />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<HorizontalStackedNijis nounIds={[`${i + 9000}`]} />)).not.toThrow();
    }
  });
  ...
  it('round-6 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <HorizontalStackedNijis key={i} nounIds={[`${i + 11000}`]} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 30 different nounIds arrays', () => {
    for (let i = 0; i < 30; i++) {
      const nounIds = Array.from({ length: 5 }, (_, j) => `${j + i + 13000}`);
      const { unmount } = render(<HorizontalStackedNijis nounIds={nounIds} />);
      unmount();
    }
  });
  ...
  it('round-6 100 rerender cycles', () => {
    const { rerender } = render(<HorizontalStackedNijis nounIds={['1']} />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<HorizontalStackedNijis nounIds={[`${i + 15000}`]} />)).not.toThrow();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <HorizontalStackedNijis key={i} nounIds={[`${i + 17000}`]} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 100 rerender cycles', () => {
    const { rerender } = render(<HorizontalStackedNijis nounIds={['1']} />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<HorizontalStackedNijis nounIds={[`${i + 19000}`]} />)).not.toThrow();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <HorizontalStackedNijis key={i} nounIds={[`${i + 21000}`]} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential HorizontalStackedNijis mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<HorizontalStackedNijis nounIds={[`${i}`]} />);
      unmount();
    }
  });
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<HorizontalStackedNijis nounIds={[`${i}`]} />)).not.toThrow();
    }
  });

  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<HorizontalStackedNijis nounIds={[`${i + 30000}`]} />);
      unmount();
    }
  });
