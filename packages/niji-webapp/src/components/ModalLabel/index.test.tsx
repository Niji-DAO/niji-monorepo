...
describe('ModalLabel', () => {
  ...
  it('round-3 mount-unmount 1000 cycles', () => {
    for (let i = 0; i < 1000; i++) {
      const { unmount } = render(<ModalLabel>r3-x</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-3 renders 2000 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 2000 }, (_, i) => (
            <ModalLabel key={i}>r3-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-3 200 different children values', () => {
    for (let i = 0; i < 200; i++) {
      const { container, unmount } = render(<ModalLabel>r3-v-{i}</ModalLabel>);
      expect(container.querySelector('div')?.textContent).toBe(`r3-v-${i}`);
      unmount();
    }
  });

  it('round-3 all 500 div wrappers exist', () => {
    const { container } = render(
      <>
        {Array.from({ length: 500 }, (_, i) => (
          <ModalLabel key={i}>txt-r3-{i}</ModalLabel>
        ))}
      </>,
    );
    expect(container.querySelectorAll('div').length).toBe(500);
  ...
  it('round-3 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r3-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-4 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r4</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-4 renders 1000 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 1000 }, (_, i) => (
            <ModalLabel key={i}>r4-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 100 different children values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<ModalLabel>r4-v-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-4 all 200 instances render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <ModalLabel key={i}>r4-x</ModalLabel>
        ))}
      </>,
    );
  ...
  it('round-4 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r4-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-5 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r5</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-5 renders 1000 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 1000 }, (_, i) => (
            <ModalLabel key={i}>r5-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 100 different children values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<ModalLabel>r5-v-{i}</ModalLabel>);
      unmount();
    }
  });

  it('round-5 all 200 instances render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <ModalLabel key={i}>r5-x</ModalLabel>
        ))}
      </>,
    );
    expect(container.children.length).toBe(200);
  ...
  it('round-5 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r5-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-6 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r6</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-6 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalLabel key={i}>r6-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r6-c-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-6 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r6-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-7 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r7</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-7 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalLabel key={i}>r7-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r7-c-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-7 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r7-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-8 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r8</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-8 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalLabel key={i}>r8-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r8-c-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-8 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r8-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-9 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalLabel>r9</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-9 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalLabel key={i}>r9-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r9-c-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-9 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r9-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });

  it('round-10 30 sequential ModalLabel mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r10-{i}</ModalLabel>);
      unmount();
    }
  });
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <ModalLabel key={i}>r10-i-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<ModalLabel>r10-s-{i}</ModalLabel>)).not.toThrow();
    }
  });

  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<ModalLabel>r10-m-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential rerender cycles second', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r10-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
  ...
  it('round-12 30 sequential ModalLabel mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalLabel>r12-m-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-12 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <ModalLabel key={i}>r12-i-{i}</ModalLabel>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-12 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<ModalLabel>r12-s-{i}</ModalLabel>)).not.toThrow();
    }
  });

  it('round-12 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<ModalLabel>r12-m2-{i}</ModalLabel>);
      unmount();
    }
  });
  ...
  it('round-12 100 sequential rerender cycles', () => {
    const { container, rerender } = render(<ModalLabel>x</ModalLabel>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalLabel>r12-r-{i}</ModalLabel>);
    }
    expect(container.querySelector('div')?.textContent).toContain('99');
  });
});
