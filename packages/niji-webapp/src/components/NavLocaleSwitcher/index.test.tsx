...
describe('NavLocaleSwitcher', () => {
  ...
  it('round-6 100 sequential mount cycles second', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<NavLocaleSwitcher />);
      unmount();
    }
  ...
  it('round-10 30 sequential NavLocaleSwitcher mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavLocaleSwitcher />);
      unmount();
    }
  ...
  it('round-11 30 sequential NavLocaleSwitcher mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavLocaleSwitcher />);
      unmount();
    }
