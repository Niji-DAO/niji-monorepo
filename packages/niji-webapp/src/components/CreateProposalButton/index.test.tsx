...
describe('CreateProposalButton', () => {
  ...
  it('round-8 30 hasEnoughVote toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateProposalButton
          handleCreateProposal={() => {}}
  ...
  it('round-9 30 hasEnoughVote toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateProposalButton
          handleCreateProposal={() => {}}
  ...
  it('round-10 30 sequential CreateProposalButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateProposalButton
          isLoading={false}
  ...
  it('round-11 30 sequential CreateProposalButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <CreateProposalButton
          isLoading={false}
