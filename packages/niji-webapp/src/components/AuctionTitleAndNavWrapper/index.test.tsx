...
describe('AuctionTitleAndNavWrapper Component', () => {
  ...
  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r5</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTitleAndNavWrapper key={i}>r5-{i}</AuctionTitleAndNavWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r5-c-{i}</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
  ...
  it('round-5 50 rerender cycles', () => {
    ...
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionTitleAndNavWrapper>r5-r-{i}</AuctionTitleAndNavWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r7</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTitleAndNavWrapper key={i}>r7-{i}</AuctionTitleAndNavWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 50 rerender cycles', () => {
    ...
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionTitleAndNavWrapper>r7-r-{i}</AuctionTitleAndNavWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-9 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r9</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
  ...
  it('round-9 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <AuctionTitleAndNavWrapper key={i}>r9-{i}</AuctionTitleAndNavWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r9-c-{i}</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
  ...
  it('round-9 50 rerender cycles', () => {
    ...
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionTitleAndNavWrapper>r9-r-{i}</AuctionTitleAndNavWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-11 30 sequential AuctionTitleAndNavWrapper mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r11-{i}</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTitleAndNavWrapper key={i}>r11-i-{i}</AuctionTitleAndNavWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<AuctionTitleAndNavWrapper>r11-s-{i}</AuctionTitleAndNavWrapper>),
      ).not.toThrow();
    }
  });
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<AuctionTitleAndNavWrapper>r11-m-{i}</AuctionTitleAndNavWrapper>);
      unmount();
    }
  });

  it('round-11 100 sequential rerender cycles second', () => {
    const { container, rerender } = render(
      <AuctionTitleAndNavWrapper>x</AuctionTitleAndNavWrapper>,
    );
    for (let i = 0; i < 100; i++) {
      rerender(<AuctionTitleAndNavWrapper>r11-r-{i}</AuctionTitleAndNavWrapper>);
    }
    expect(container.textContent).toContain('99');
  });
});
