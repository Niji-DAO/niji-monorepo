...
describe('ModalBottomButtonRow', () => {
  ...
  it('round-8 rapid 200 onPrev/onNext invocations', () => {
    const onPrev = vi.fn();
    const onNext = vi.fn();
    render(
      <ModalBottomButtonRow
  ...
  it('round-9 rapid 200 onPrev/onNext invocations', () => {
    const onPrev = vi.fn();
    const onNext = vi.fn();
    render(
      <ModalBottomButtonRow
  ...
  it('round-10 30 sequential ModalBottomButtonRow mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ModalBottomButtonRow
          prevBtnText="prev"
  ...
  it('round-10 100 sequential onPrev + onNext invocations', () => {
    const onPrev = vi.fn();
    const onNext = vi.fn();
    render(
      <ModalBottomButtonRow
