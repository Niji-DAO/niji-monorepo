...
describe('CurrentDelegatePannel', () => {
  ...
  it('round-2 rapid 500 onPrimary clicks', () => {
    useAccountMock.mockReturnValue({ address: '0xACCT' });
    useReadNijiTokenDelegatesMock.mockReturnValue({ data: undefined });
    const onPri = vi.fn();
    const { container } = render(
    ...
    const buttons = container.querySelectorAll('button');
    for (let i = 0; i < 500; i++) fireEvent.click(buttons[1]);
    expect(onPri).toHaveBeenCalledTimes(500);
  });

  it('round-2 handles 50 different delegate addresses', () => {
    useAccountMock.mockReturnValue({ address: '0xACCT' });
    for (let i = 0; i < 50; i++) {
      useReadNijiTokenDelegatesMock.mockReturnValue({
        data: '0x' + i.toString(16).padStart(40, '0'),
  ...
  it('round-2 all 100 instances render Delegation h1', () => {
    useAccountMock.mockReturnValue({ address: '0xACCT' });
    useReadNijiTokenDelegatesMock.mockReturnValue({ data: undefined });
    const { container } = render(
      <>
  ...
  it('round-4 rapid 200 onPrimaryBtnClick invocations', () => {
    const onPrimaryBtnClick = vi.fn();
    render(<CurrentDelegatePannel onPrimaryBtnClick={onPrimaryBtnClick} />);
    for (let i = 0; i < 200; i++) onPrimaryBtnClick();
    expect(onPrimaryBtnClick).toHaveBeenCalledTimes(200);
  ...
  it('round-6 rapid 200 onPrimaryBtnClick invocations', () => {
    const onPrimaryBtnClick = vi.fn();
    render(<CurrentDelegatePannel onPrimaryBtnClick={onPrimaryBtnClick} />);
    for (let i = 0; i < 200; i++) onPrimaryBtnClick();
    expect(onPrimaryBtnClick).toHaveBeenCalledTimes(200);
  ...
  it('round-8 rapid 200 onPrimaryBtnClick invocations', () => {
    const onPrimaryBtnClick = vi.fn();
    render(<CurrentDelegatePannel onPrimaryBtnClick={onPrimaryBtnClick} />);
    for (let i = 0; i < 200; i++) onPrimaryBtnClick();
    expect(onPrimaryBtnClick).toHaveBeenCalledTimes(200);
  ...
  it('round-9 rapid 200 onPrimaryBtnClick invocations', () => {
    const onPrimaryBtnClick = vi.fn();
    render(<CurrentDelegatePannel onPrimaryBtnClick={onPrimaryBtnClick} />);
    for (let i = 0; i < 200; i++) onPrimaryBtnClick();
    expect(onPrimaryBtnClick).toHaveBeenCalledTimes(200);
