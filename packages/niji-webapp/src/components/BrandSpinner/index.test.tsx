...
describe('BrandSpinner', () => {
  ...
  it('round-6 200 sequential mount cycles', () => {
    for (let i = 0; i < 200; i++) {
      const { unmount } = render(<BrandSpinner />);
      unmount();
    }
  ...
  it('round-8 200 sequential mount cycles', () => {
    for (let i = 0; i < 200; i++) {
      const { unmount } = render(<BrandSpinner />);
      unmount();
    }
  ...
  it('round-10 30 sequential BrandSpinner mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BrandSpinner />);
      unmount();
    }
  ...
  it('round-12 30 sequential BrandSpinner mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BrandSpinner />);
      unmount();
    }
