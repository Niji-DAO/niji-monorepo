...
describe('ForkStatus', () => {
  ...
  it('round-10 30 sequential ForkStatus mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ForkStatus />);
      unmount();
    }
