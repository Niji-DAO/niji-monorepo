...
describe('EditProposalButton', () => {
  ...
  it('round-3 30 isCandidate toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-3 30 hasActiveOrPendingProposal toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
  ...
  it('round-3 all 200 instances render button', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <EditProposalButton key={i} {...defaults} />
  ...
  it('round-5 all 200 buttons render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <EditProposalButton key={i} {...defaults} />
  ...
  it('round-6 all 200 buttons render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <EditProposalButton key={i} {...defaults} />
  ...
  it('round-7 200 button instances render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <EditProposalButton key={i} {...defaults} />
  ...
  it('round-9 200 button instances render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <EditProposalButton key={i} {...defaults} />
  ...
  it('round-10 30 sequential EditProposalButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<EditProposalButton {...defaults} />);
      unmount();
    }
  ...
  it('round-12 30 sequential EditProposalButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<EditProposalButton {...defaults} />);
      unmount();
    }
