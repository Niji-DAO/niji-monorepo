...
describe('TightStackedCircleNiji', () => {
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TightStackedCircleNiji key={i} index={i} nounId={BigInt(i + 11000)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 50 different index values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i + 13000} nounId={1n} />);
      unmount();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TightStackedCircleNiji key={i} index={i} nounId={BigInt(i + 15000)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 50 different index values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i + 17000} nounId={1n} />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TightStackedCircleNiji key={i} index={i} nounId={1n} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different nounId values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={0} nounId={BigInt(i + 1)} />);
      unmount();
    }
  });
  ...
  it('round-9 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i} nounId={2n} />);
      unmount();
    }
  });

  it('round-10 30 sequential TightStackedCircleNiji mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i} nounId={1n} />);
      unmount();
    }
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<TightStackedCircleNiji index={i} nounId={BigInt(i + 1)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i} nounId={BigInt(i + 30000)} />);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential different index values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<TightStackedCircleNiji index={i + 40000} nounId={1n} />);
      unmount();
    }
  });
});
