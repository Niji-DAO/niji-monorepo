...
describe('NavBarButton', () => {
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText="r6" />);
      unmount();
    }
  });
  ...
  it('round-6 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavBarButton key={i} buttonText={`r6-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 30 different buttonText values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r6-t-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText="r7" />);
      unmount();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavBarButton key={i} buttonText={`r7-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 different buttonText values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r7-bt-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText="r9" />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavBarButton key={i} buttonText={`r9-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different buttonText values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r9-bt-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-11 30 sequential NavBarButton mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r11-m-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavBarButton key={i} buttonText={`r11-i-${i}`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<NavBarButton buttonText={`r11-s-${i}`} />)).not.toThrow();
    }
  });

  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r11-m2-${i}`} />);
      unmount();
    }
  });

  it('round-11 100 sequential different buttonText values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<NavBarButton buttonText={`r11-c-${i}`} />);
      unmount();
    }
  });
});
