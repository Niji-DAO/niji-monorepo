...
describe('Modal', () => {
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Modal title="r6" content={<p>r6</p>} onDismiss={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-6 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Modal key={i} title={`r6-${i}`} content={<p>r6-{i}</p>} onDismiss={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Modal title="r8" content={<p>r8</p>} onDismiss={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Modal key={i} title={`r8-${i}`} content={<p>r8-{i}</p>} onDismiss={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Modal title="r9" content={<p>r9</p>} onDismiss={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Modal key={i} title={`r9-${i}`} content={<p>r9-{i}</p>} onDismiss={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
