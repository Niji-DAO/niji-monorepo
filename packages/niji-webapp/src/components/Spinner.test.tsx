...
describe('Spinner', () => {
  ...
  it('round-6 200 sequential renders second cycle', () => {
    for (let i = 0; i < 200; i++) {
      expect(() => render(<Spinner />)).not.toThrow();
    }
  });
  ...
  it('round-7 200 sequential renders second cycle', () => {
    for (let i = 0; i < 200; i++) {
      expect(() => render(<Spinner />)).not.toThrow();
    }
  });
  ...
  it('round-8 200 sequential renders second cycle', () => {
    for (let i = 0; i < 200; i++) {
      expect(() => render(<Spinner />)).not.toThrow();
    }
  });
  ...
  it('round-9 200 sequential renders second cycle', () => {
    for (let i = 0; i < 200; i++) {
      expect(() => render(<Spinner />)).not.toThrow();
    }
  });

  it('round-10 30 sequential Spinner mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Spinner />);
      unmount();
    }
  ...
  it('round-11 30 sequential Spinner mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Spinner />);
      unmount();
    }
