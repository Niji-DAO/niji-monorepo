...
describe('Link', () => {
  ...
  it('round-7 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<Link text="r7" url="https://r7.io" />);
      unmount();
    }
  });
  ...
  it('round-7 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <Link key={i} text={`r7-${i}`} url={`https://r7-${i}.io`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 different text values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Link text={`r7-c-${i}`} url={`https://r7-c-${i}.io`} />);
      unmount();
    }
  });
  ...
  it('round-7 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<Link text="x" url="https://r7.io" />);
      unmount();
    }
  });

  it('round-7 100 rerender cycles', () => {
    const { rerender } = render(<Link text="x" url="https://r7.io" />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<Link text={`r${i}`} url={`https://r7-${i}.io`} />)).not.toThrow();
    }
  });

  it('round-8 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<Link text="r8" url="https://r8.io" />);
      unmount();
    }
  });
  ...
  it('round-8 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <Link key={i} text={`r8-${i}`} url={`https://r8-${i}.io`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 different text values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Link text={`r8-c-${i}`} url={`https://r8-c-${i}.io`} />);
      unmount();
    }
  });
  ...
  it('round-8 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<Link text="x" url="https://r8.io" />);
      unmount();
    }
  });

  it('round-8 100 rerender cycles', () => {
    const { rerender } = render(<Link text="x" url="https://r8.io" />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<Link text={`r${i}`} url={`https://r8-${i}.io`} />)).not.toThrow();
    }
  });

  it('round-9 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<Link text="r9" url="https://r9.io" />);
      unmount();
    }
  });
  ...
  it('round-9 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <Link key={i} text={`r9-${i}`} url={`https://r9-${i}.io`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different text values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Link text={`r9-c-${i}`} url={`https://r9-c-${i}.io`} />);
      unmount();
    }
  });
  ...
  it('round-9 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<Link text="x" url="https://r9.io" />);
      unmount();
    }
  });

  it('round-9 100 rerender cycles', () => {
    const { rerender } = render(<Link text="x" url="https://r9.io" />);
    for (let i = 0; i < 100; i++) {
      expect(() => rerender(<Link text={`r${i}`} url={`https://r9-${i}.io`} />)).not.toThrow();
    }
  });

  it('round-10 30 sequential Link mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Link text="r10" url="https://r10.io" />);
      unmount();
    }
  });
  ...
  it('round-10 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Link key={i} text={`r10-${i}`} url={`https://r10-${i}.io`} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<Link text="r10" url="https://r10.io" />)).not.toThrow();
    }
  });

  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<Link text={`r10-m-${i}`} url={`https://r10-m-${i}.io`} />);
      unmount();
    }
  });

  it('round-10 100 sequential rerender cycles second', () => {
    const { rerender } = render(<Link text="x" url="https://r10.io" />);
    for (let i = 0; i < 100; i++) {
