...
describe('VoteProgressBar', () => {
  ...
  it('round-2 handles 100 different percentage values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.FOR} percentage={i + 1} />,
      );
      unmount();
    }
  });

  it('round-2 handles all 3 variant cycles 50 times each', () => {
    const variants = [VoteCardVariant.FOR, VoteCardVariant.AGAINST, VoteCardVariant.ABSTAIN];
    for (let i = 0; i < 50; i++) {
      for (const v of variants) {
        const { unmount } = render(<VoteProgressBar variant={v} percentage={50} />);
        unmount();
      }
    }
  });

  it('round-2 rapid 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-3 100 different percentage values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.FOR} percentage={i + 1} />,
      );
  ...
  it('round-3 50 variants cycles', () => {
    const variants = [VoteCardVariant.FOR, VoteCardVariant.AGAINST, VoteCardVariant.ABSTAIN];
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<VoteProgressBar variant={variants[i % 3]} percentage={50} />);
      unmount();
    }
  });
  ...
  it('round-4 100 different percentage values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.FOR} percentage={i + 1} />,
      );
  ...
  it('round-4 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-6 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-6 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-7 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-8 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-9 200 rerender cycles', () => {
    const { rerender } = render(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={50} />);
    for (let i = 0; i < 200; i++) {
      expect(() =>
        rerender(<VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />),
  ...
  it('round-11 30 sequential VoteProgressBar mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />,
      );
      unmount();
    }
  });
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<VoteProgressBar variant={VoteCardVariant.AGAINST} percentage={i % 100} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.ABSTAIN} percentage={i % 100} />,
      );
      unmount();
    }
  });
  ...
  it('round-12 30 sequential VoteProgressBar mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <VoteProgressBar variant={VoteCardVariant.FOR} percentage={i % 100} />,
      );
