...
describe('ProposalStatusCopy', () => {
  ...
  it('round-10 30 sequential ProposalStatusCopy mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ProposalStatusCopy proposal={makeProposal(ProposalState.ACTIVE)} />,
      );
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<ProposalStatusCopy proposal={makeProposal(ProposalState.PENDING)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-12 30 sequential ProposalStatusCopy mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ProposalStatusCopy proposal={makeProposal(ProposalState.ACTIVE)} />,
      );
