...
describe('BidHistoryBtn Component (isCool=true)', () => {
  ...
  it('round-10 30 sequential BidHistoryBtn mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BidHistoryBtn onClick={() => {}} />);
      unmount();
    }
  ...
  it('round-10 100 sequential onClick invocations', () => {
    const cb = vi.fn();
    render(<BidHistoryBtn onClick={cb} />);
    for (let i = 0; i < 100; i++) cb();
    expect(cb).toHaveBeenCalledTimes(100);
  });

  it('round-11 30 sequential BidHistoryBtn mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BidHistoryBtn onClick={() => {}} />);
      unmount();
    }
  ...
  it('round-12 30 sequential BidHistoryBtn mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<BidHistoryBtn onClick={() => {}} />);
      unmount();
    }
