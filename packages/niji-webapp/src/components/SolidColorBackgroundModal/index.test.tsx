...
describe('SolidColorBackgroundModal', () => {
  ...
  it('round-4 30 different content nodes', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal
          show={true}
          onDismiss={() => {}}
          content={<div data-testid={`r4-${i}`}>{i + 500}</div>}
        />,
      );
      unmount();
    }
  ...
  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<div>r5</div>} />,
      );
      unmount();
    }
  });
  ...
  it('round-5 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(
          <SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<div>x</div>} />,
        ),
      ).not.toThrow();
    }
  });
    ...
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal
          show={true}
          onDismiss={() => {}}
          content={<div data-testid={`r5-${i}`}>{i + 500}</div>}
        />,
      );
      unmount();
    }
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<div>r6</div>} />,
      );
      unmount();
    }
  });
  ...
  it('round-6 30 different content cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal
          show={true}
          onDismiss={() => {}}
          content={<div data-testid={`r6-${i}`}>{i + 9000}</div>}
        />,
      );
      unmount();
    }
  ...
  it('round-8 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<p>r8</p>} />,
      );
      unmount();
    }
  });
        ...
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <SolidColorBackgroundModal
              ...
              show={true}
              onDismiss={() => {}}
              content={<div data-testid={`r8-${i}`}>{i + 15000}</div>}
            />
          ))}
        </>,
      ),
  ...
  it('round-8 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<p>r8</p>} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-8 30 different content cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal
          show={true}
          onDismiss={() => {}}
          content={<div data-testid={`r8-${i}`}>{i + 17000}</div>}
        />,
      );
      unmount();
    }
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<p>r9</p>} />,
      );
      unmount();
    }
  });
        ...
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <SolidColorBackgroundModal
              ...
              show={true}
              onDismiss={() => {}}
              content={<div data-testid={`r9-${i}`}>{i + 19000}</div>}
            />
          ))}
        </>,
      ),
  ...
  it('round-9 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<SolidColorBackgroundModal show={true} onDismiss={() => {}} content={<p>r9</p>} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-9 30 different content cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SolidColorBackgroundModal
          show={true}
          onDismiss={() => {}}
          content={<div data-testid={`r9-${i}`}>{i + 21000}</div>}
        />,
      );
      unmount();
    }
