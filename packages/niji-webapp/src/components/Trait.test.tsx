...
describe('Trait', () => {
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Trait type="hat" seed={1} />, { wrapper: WithProviders });
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Trait key={i} type="hat" seed={i * 29} />
          ))}
        </>,
        { wrapper: WithProviders },
      ),
  ...
  it('round-9 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<Trait type="hat" seed={1} />, { wrapper: WithProviders })).not.toThrow();
    }
  });
  ...
  it('round-9 30 different seed values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Trait type="hat" seed={i * 31} />, { wrapper: WithProviders });
      unmount();
    }
  });

  it('round-10 30 sequential Trait mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Trait type="hat" seed={i} />, { wrapper: WithProviders });
      unmount();
    }
  ...
  it('round-10 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <Trait key={i} type="hat" seed={i + 100} />
          ))}
        </>,
        { wrapper: WithProviders },
      ),
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<Trait type="hat" seed={i + 300} />, {
        wrapper: WithProviders,
      });
      unmount();
    }
  ...
  it('round-10 100 sequential mount-unmount cycles', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<Trait type="hat" seed={i + 400} />, {
        wrapper: WithProviders,
      });
      unmount();
    }
