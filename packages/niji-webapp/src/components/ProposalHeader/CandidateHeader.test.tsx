...
describe('CandidateHeader', () => {
  ...
  it('round-10 30 sequential CandidateHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateHeader {...defaults} />);
      unmount();
    }
  ...
  it('round-11 30 sequential CandidateHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateHeader {...defaults} />);
      unmount();
    }
  ...
  it('round-12 30 sequential CandidateHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateHeader {...defaults} />);
      unmount();
    }
