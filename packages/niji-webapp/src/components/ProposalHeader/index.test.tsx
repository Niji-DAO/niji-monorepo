...
describe('ProposalHeader', () => {
  ...
  it('round-3 30 different title values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<ProposalHeader {...baseProps} title={`r3-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-4 30 different title values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<ProposalHeader {...baseProps} title={`r4-${i}`} />);
      unmount();
    }
  });
  ...
  it('round-10 30 sequential ProposalHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<ProposalHeader {...baseProps} />);
      unmount();
    }
  ...
  it('round-12 30 sequential ProposalHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<ProposalHeader {...baseProps} />);
      unmount();
    }
