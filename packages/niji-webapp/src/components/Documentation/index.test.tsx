...
describe('Documentation', () => {
  ...
  it('round-3 30 different backgroundColor values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Documentation backgroundColor={`#r3${i}`} />);
      unmount();
    }
  });
  ...
  it('round-4 30 different backgroundColor values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Documentation backgroundColor={`#r4${i}`} />);
      unmount();
    }
  });
  ...
  it('round-10 30 sequential Documentation mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<Documentation />);
      unmount();
    }
