...
describe('AuctionActivityWrapper', () => {
  ...
  it('round-3 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r3-x</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-3 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <AuctionActivityWrapper key={i}>r3-{i}</AuctionActivityWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-3 100 different children values', () => {
    for (let i = 0; i < 100; i++) {
      const { container, unmount } = render(
        <AuctionActivityWrapper>r3-v-{i}</AuctionActivityWrapper>,
      );
  ...
  it('round-3 50 rerender cycles', () => {
    const { container, rerender } = render(<AuctionActivityWrapper>x</AuctionActivityWrapper>);
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionActivityWrapper>r3-r-{i}</AuctionActivityWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r5</AuctionActivityWrapper>);
      unmount();
    }
  });
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionActivityWrapper key={i}>r5-{i}</AuctionActivityWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r5-c-{i}</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-5 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<AuctionActivityWrapper>x</AuctionActivityWrapper>)).not.toThrow();
    }
  });

  it('round-5 50 rerender cycles', () => {
    const { container, rerender } = render(<AuctionActivityWrapper>x</AuctionActivityWrapper>);
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionActivityWrapper>r5-r-{i}</AuctionActivityWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r6</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-6 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionActivityWrapper key={i}>r6-{i}</AuctionActivityWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r6-c-{i}</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-6 50 rerender cycles', () => {
    const { container, rerender } = render(<AuctionActivityWrapper>x</AuctionActivityWrapper>);
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionActivityWrapper>r6-r-{i}</AuctionActivityWrapper>);
    }
    expect(container.textContent).toContain('49');
  });
  ...
  it('round-9 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r9</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-9 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <AuctionActivityWrapper key={i}>r9-{i}</AuctionActivityWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r9-c-{i}</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-9 50 rerender cycles', () => {
    const { container, rerender } = render(<AuctionActivityWrapper>x</AuctionActivityWrapper>);
    for (let i = 0; i < 50; i++) {
      rerender(<AuctionActivityWrapper>r9-r-{i}</AuctionActivityWrapper>);
    }
    expect(container.textContent).toContain('49');
  });

  it('round-10 30 sequential AuctionActivityWrapper mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r10-{i}</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-10 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionActivityWrapper key={i}>r10-i-{i}</AuctionActivityWrapper>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<AuctionActivityWrapper>r10-s-{i}</AuctionActivityWrapper>),
      ).not.toThrow();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<AuctionActivityWrapper>r10-m-{i}</AuctionActivityWrapper>);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential rerender cycles second', () => {
    const { container, rerender } = render(<AuctionActivityWrapper>x</AuctionActivityWrapper>);
    for (let i = 0; i < 100; i++) {
      rerender(<AuctionActivityWrapper>r10-r-{i}</AuctionActivityWrapper>);
    }
