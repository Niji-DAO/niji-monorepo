...
describe('AuctionTimer Component', () => {
  ...
  it('round-3 30 different endTime offsets', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionTimer auction={mockAuction(60 + i * 60)} auctionEnded={false} />,
      );
  ...
  it('round-4 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTimer key={i} auction={mockAuction(3600 + i + 500)} auctionEnded={false} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<AuctionTimer auction={mockAuction(3600 + i + 1500)} auctionEnded={false} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-4 30 auctionEnded toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionTimer auction={mockAuction(3600)} auctionEnded={i % 2 === 0} />,
      );
      unmount();
    }
  });
  ...
  it('round-4 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() =>
        render(<AuctionTimer auction={mockAuction(3600 + i + 3000)} auctionEnded={false} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-5 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() =>
        render(<AuctionTimer auction={mockAuction(3600 + i + 5000)} auctionEnded={false} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTimer key={i} auction={mockAuction(3600 + i + 11000)} auctionEnded={false} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() =>
        render(<AuctionTimer auction={mockAuction(3600 + i + 13000)} auctionEnded={false} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionTimer key={i} auction={mockAuction(3600 + i + 15000)} auctionEnded={false} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() =>
        render(<AuctionTimer auction={mockAuction(3600 + i + 17000)} auctionEnded={false} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-9 30 different endTime values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionTimer auction={mockAuction(3600 + i)} auctionEnded={false} />,
      );
      unmount();
    }
  });
  ...
  it('round-9 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<AuctionTimer auction={mockAuction(7200)} auctionEnded={true} />);
      unmount();
    }
  });

  it('round-10 30 sequential AuctionTimer mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionTimer auction={mockAuction(3600)} auctionEnded={false} />);
      unmount();
    }
  ...
  it('round-10 100 sequential different endTime values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <AuctionTimer auction={mockAuction(7200 + i)} auctionEnded={true} />,
      );
      unmount();
    }
  });
