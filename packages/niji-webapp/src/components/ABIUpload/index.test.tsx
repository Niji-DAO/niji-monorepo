...
describe('ABIUpload Component', () => {
  ...
  it('rerender between valid and invalid 50 times', () => {
    const { rerender } = render(
      <ABIUpload abiFileName="x.json" isValid={false} isInvalid={false} onChange={vi.fn()} />,
    );
    for (let i = 0; i < 50; i++) {
  ...
  it('all 50 instances have type=file input', () => {
    const { container } = render(
      <>
        {Array.from({ length: 50 }, (_, i) => (
          <ABIUpload
  ...
  it('handles falsy "" filename in repeated rerender', () => {
    const { rerender } = render(
      <ABIUpload abiFileName="" isValid={false} isInvalid={false} onChange={vi.fn()} />,
    );
    for (let i = 0; i < 30; i++) {
      expect(() =>
        rerender(<ABIUpload abiFileName="" isValid={false} isInvalid={false} onChange={vi.fn()} />),
      ).not.toThrow();
    }
  });

  it('handles consecutive 50 mount-unmount cycles', () => {
    for (let i = 0; i < 50; i++) {
  ...
  it('round-3 mount-unmount 200 cycles', () => {
    for (let i = 0; i < 200; i++) {
      const { unmount } = render(
        <ABIUpload abiFileName="r3.json" isValid={false} isInvalid={false} onChange={vi.fn()} />,
      );
      unmount();
    }
  });
  ...
  it('round-3 30 different abiFileName values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName={`r3-file-${i}.json`}
          isValid={false}
          isInvalid={false}
          onChange={vi.fn()}
        />,
  ...
  it('round-3 30 isValid toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName="x.json"
  ...
  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload abiFileName="r5.json" isValid={false} isInvalid={false} onChange={vi.fn()} />,
      );
      unmount();
    }
  });
  ...
  it('round-5 30 different fileName values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName={`r5-f-${i}.json`}
          isValid={false}
          isInvalid={false}
          onChange={vi.fn()}
        />,
  ...
  it('round-6 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload abiFileName="r6.json" isValid={false} isInvalid={false} onChange={vi.fn()} />,
      );
      unmount();
    }
  });
  ...
  it('round-6 30 different fileName values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName={`r6-f-${i}.json`}
          isValid={false}
          isInvalid={false}
          onChange={vi.fn()}
        />,
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload abiFileName="r7.json" isValid={false} isInvalid={false} onChange={vi.fn()} />,
      );
      unmount();
    }
  });
  ...
  it('round-7 30 different abiFileName values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName={`r7-f-${i}.json`}
          isValid={false}
          isInvalid={false}
          onChange={vi.fn()}
        />,
  ...
  it('round-8 30 different abiFileName values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <ABIUpload
          abiFileName={`r8-f-${i}.json`}
          isValid={false}
          isInvalid={false}
          onChange={vi.fn()}
        />,
