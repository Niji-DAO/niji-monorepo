...
describe('ModalTitle', () => {
  ...
  it('round-6 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalTitle>r6</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-6 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalTitle key={i}>r6-{i}</ModalTitle>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-6 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalTitle>r6-c-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-6 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalTitle>x</ModalTitle>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalTitle>r6-r-{i}</ModalTitle>);
    }
    expect(container.textContent).toContain('99');
  });
  ...
  it('round-7 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalTitle>r7</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-7 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalTitle key={i}>r7-{i}</ModalTitle>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalTitle>r7-c-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-7 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalTitle>x</ModalTitle>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalTitle>r7-r-{i}</ModalTitle>);
    }
    expect(container.textContent).toContain('99');
  });
  ...
  it('round-8 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalTitle>r8</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-8 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalTitle key={i}>r8-{i}</ModalTitle>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalTitle>r8-c-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-8 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalTitle>x</ModalTitle>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalTitle>r8-r-{i}</ModalTitle>);
    }
    expect(container.textContent).toContain('99');
  });
  ...
  it('round-9 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<ModalTitle>r9</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-9 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <ModalTitle key={i}>r9-{i}</ModalTitle>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different children values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalTitle>r9-c-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-9 100 rerender cycles', () => {
    const { container, rerender } = render(<ModalTitle>x</ModalTitle>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalTitle>r9-r-{i}</ModalTitle>);
    }
    expect(container.textContent).toContain('99');
  });
  ...
  it('round-12 30 sequential ModalTitle mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<ModalTitle>r12-m-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-12 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <ModalTitle key={i}>r12-i-{i}</ModalTitle>
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-12 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<ModalTitle>r12-s-{i}</ModalTitle>)).not.toThrow();
    }
  });

  it('round-12 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<ModalTitle>r12-m2-{i}</ModalTitle>);
      unmount();
    }
  });
  ...
  it('round-12 100 sequential rerender cycles', () => {
    const { container, rerender } = render(<ModalTitle>x</ModalTitle>);
    for (let i = 0; i < 100; i++) {
      rerender(<ModalTitle>r12-r-{i}</ModalTitle>);
    }
    expect(container.textContent).toContain('99');
  });
});
