...
describe('EnsOrLongAddress', () => {
  ...
  it('handles 200 different ENS names', () => {
    for (let i = 0; i < 200; i++) {
      vi.mocked(useReverseENSLookUp).mockReturnValue(`ens-${i}.eth`);
      vi.mocked(containsBlockedText).mockReturnValue(false);
      const { container, unmount } = render(<EnsOrLongAddress address={ADDR} />);
      expect(container.textContent).toBe(`ens-${i}.eth`);
      unmount();
    }
  });

  it('all 500 instances render ENS text when set', () => {
    vi.mocked(useReverseENSLookUp).mockReturnValue('test.eth');
    vi.mocked(containsBlockedText).mockReturnValue(false);
    const { container } = render(
      <>
    ...
    const matches = (container.textContent ?? '').match(/test\.eth/g);
    expect(matches?.length).toBe(500);
  });

  it('handles 100 rapid blocked vs not blocked transitions', () => {
    const { rerender } = render(<EnsOrLongAddress address={ADDR} />);
    for (let i = 0; i < 100; i++) {
      vi.mocked(useReverseENSLookUp).mockReturnValue('ens.eth');
  ...
  it('round-2 mount-unmount 200 cycles', () => {
    for (let i = 0; i < 200; i++) {
      const { unmount } = render(<EnsOrLongAddress address="0xABC" />);
      unmount();
    }
  });
  ...
  it('round-2 handles 50 different address values', () => {
    for (let i = 0; i < 50; i++) {
      const addr = ('0x' + i.toString(16).padStart(40, '0')) as `0x${string}`;
      const { unmount } = render(<EnsOrLongAddress address={addr} />);
      unmount();
  ...
  it('round-2 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() => render(<EnsOrLongAddress address="0xR2" />)).not.toThrow();
    }
  });
  ...
  it('round-3 50 different address values', () => {
    for (let i = 0; i < 50; i++) {
      const addr = ('0x' + i.toString(16).padStart(40, '0')) as `0x${string}`;
      const { unmount } = render(<EnsOrLongAddress address={addr} />);
      unmount();
  ...
  it('round-3 50 sequential renders without crash', () => {
    for (let i = 0; i < 50; i++) {
      expect(() => render(<EnsOrLongAddress address="0xR3" />)).not.toThrow();
    }
  });
  ...
  it('round-5 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<EnsOrLongAddress address="0x0" />);
      unmount();
    }
  });
  ...
  it('round-5 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <EnsOrLongAddress key={i} address="0x0" />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<EnsOrLongAddress address="0x0" />)).not.toThrow();
    }
  });
  ...
  it('round-6 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      const addr = ('0xR6' + '0'.padStart(38, '0')) as `0x${string}`;
      expect(() => render(<EnsOrLongAddress address={addr} />)).not.toThrow();
    }
  });
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<EnsOrLongAddress address="0xR7" />);
      unmount();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const addr = ('0xR7' + i.toString(16).padStart(38, '0')) as `0x${string}`;
            return <EnsOrLongAddress key={i} address={addr} />;
          })}
        </>,
      ),
  ...
  it('round-7 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<EnsOrLongAddress address="0xR7" />)).not.toThrow();
    }
  });
  ...
  it('round-9 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<EnsOrLongAddress address="0xR9" />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const addr = ('0xR9' + i.toString(16).padStart(38, '0')) as `0x${string}`;
            return <EnsOrLongAddress key={i} address={addr} />;
          })}
        </>,
      ),
  ...
  it('round-9 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<EnsOrLongAddress address="0xR9" />)).not.toThrow();
    }
  });
  ...
  it('round-10 30 sequential EnsOrLongAddress mount-unmount cycles', () => {
  ...
  it('round-11 30 sequential EnsOrLongAddress mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const addr = ('0xR11I' + i.toString(16).padStart(36, '0')) as `0x${string}`;
            return <EnsOrLongAddress key={i} address={addr} />;
          })}
        </>,
      ),
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      const addr = ('0xR11S' + i.toString(16).padStart(36, '0')) as `0x${string}`;
      expect(() => render(<EnsOrLongAddress address={addr} />)).not.toThrow();
    }
  });
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const addr = ('0xR11M' + i.toString(16).padStart(36, '0')) as `0x${string}`;
      const { unmount } = render(<EnsOrLongAddress address={addr} />);
      unmount();
    }
  });
