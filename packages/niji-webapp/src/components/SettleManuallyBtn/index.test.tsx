...
describe('SettleManuallyBtn', () => {
  ...
  it('round-4 rapid 200 handler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
  ...
  it('round-4 100 sequential mount-unmount cycles', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <SettleManuallyBtn settleAuctionHandler={() => {}} auction={auction} />,
      );
  ...
  it('round-5 rapid 200 settleAuctionHandler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
    for (let i = 0; i < 200; i++) handler();
    expect(handler).toHaveBeenCalledTimes(200);
  ...
  it('round-6 rapid 200 settleAuctionHandler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
    for (let i = 0; i < 200; i++) handler();
    expect(handler).toHaveBeenCalledTimes(200);
  ...
  it('round-7 rapid 200 settleAuctionHandler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
    for (let i = 0; i < 200; i++) handler();
    expect(handler).toHaveBeenCalledTimes(200);
  ...
  it('round-8 rapid 200 settleAuctionHandler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
    for (let i = 0; i < 200; i++) handler();
    expect(handler).toHaveBeenCalledTimes(200);
  ...
  it('round-9 rapid 200 settleAuctionHandler invocations', () => {
    const handler = vi.fn();
    render(<SettleManuallyBtn settleAuctionHandler={handler} auction={auction} />);
    for (let i = 0; i < 200; i++) handler();
    expect(handler).toHaveBeenCalledTimes(200);
  ...
  it('round-10 30 sequential SettleManuallyBtn mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SettleManuallyBtn settleAuctionHandler={() => {}} auction={auction} />,
      );
  ...
  it('round-11 30 sequential SettleManuallyBtn mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <SettleManuallyBtn settleAuctionHandler={() => {}} auction={auction} />,
      );
