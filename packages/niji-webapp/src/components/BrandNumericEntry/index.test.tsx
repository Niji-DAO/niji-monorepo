...
describe('BrandNumericEntry', () => {
  ...
  it('round-2 mount-unmount 500 cycles', () => {
    for (let i = 0; i < 500; i++) {
      const { unmount } = render(<BrandNumericEntry value={0} onValueChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-2 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <BrandNumericEntry key={i} value={i} onValueChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-2 handles 100 different value values no crash', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<BrandNumericEntry value={i + 1000} onValueChange={() => {}} />);
      unmount();
    }
  });

  it('round-2 rapid 200 onValueChange events', () => {
    const onValueChange = vi.fn();
    const { container } = render(<BrandNumericEntry value={0} onValueChange={onValueChange} />);
    const input = container.querySelector('input')!;
    for (let i = 1; i <= 200; i++) {
      fireEvent.change(input, { target: { value: `${i + 1000}` } });
    }
    expect(onValueChange.mock.calls.length).toBeGreaterThan(150);
  });

  it('round-2 all 200 instances have single input', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <BrandNumericEntry key={i} value={i} onValueChange={() => {}} />
  ...
  it('round-3 50 different value cycles', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<BrandNumericEntry value={i + 100} onValueChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-3 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<BrandNumericEntry value={0} onValueChange={() => {}} />)).not.toThrow();
    }
  });

  it('round-3 all 100 instances render input', () => {
    const { container } = render(
      <>
        {Array.from({ length: 100 }, (_, i) => (
          <BrandNumericEntry key={i} value={i} onValueChange={() => {}} />
  ...
  it('round-4 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <BrandNumericEntry key={i} value={i + 100} onValueChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 50 different value cycles', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<BrandNumericEntry value={i + 500} onValueChange={() => {}} />);
      unmount();
    }
  });
  ...
  it('round-4 all 100 instances render input', () => {
    const { container } = render(
      <>
        {Array.from({ length: 100 }, (_, i) => (
          <BrandNumericEntry key={i} value={i + 200} onValueChange={() => {}} />
        ))}
      </>,
    );
    expect(container.querySelectorAll('input').length).toBe(100);
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandNumericEntry key={i} value={i + 1000} onValueChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 rapid 200 onValueChange invocations', () => {
    const onValueChange = vi.fn();
  ...
  it('round-5 100 sequential value variants', () => {
    const { container } = render(
      <>
        {Array.from({ length: 100 }, (_, i) => (
          <BrandNumericEntry key={i} value={i + 500} onValueChange={() => {}} />
        ))}
      </>,
    );
    expect(container.querySelectorAll('input').length).toBe(100);
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandNumericEntry key={i} value={i + 11000} onValueChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 100 inputs render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 100 }, (_, i) => (
          <BrandNumericEntry key={i} value={i + 13000} onValueChange={() => {}} />
        ))}
      </>,
    );
    expect(container.querySelectorAll('input').length).toBe(100);
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <BrandNumericEntry key={i} value={i + 15000} onValueChange={() => {}} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 100 inputs render', () => {
    const { container } = render(
      <>
        {Array.from({ length: 100 }, (_, i) => (
          <BrandNumericEntry key={i} value={i + 17000} onValueChange={() => {}} />
        ))}
      </>,
    );
    expect(container.querySelectorAll('input').length).toBe(100);
