...
describe('VoteSignalsHeader — additional', () => {
  ...
  it('round-9 30 different isCandidate values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteSignalsHeader isCandidate={i % 2 === 0} />);
      unmount();
    }
  ...
  it('round-9 30 VoteSignalsFootnote mounts', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteSignalsFootnote />);
      unmount();
    }
  ...
  it('round-10 30 sequential VoteSignalsHeader mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<VoteSignalsHeader />);
      unmount();
    }
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<VoteSignalsHeader />)).not.toThrow();
    }
  });
  ...
  it('round-10 100 VoteSignalsFootnote mount-unmount cycles', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<VoteSignalsFootnote />);
      unmount();
    }
