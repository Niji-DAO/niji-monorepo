...
describe('AuctionNavigation Component', () => {
  ...
  it('round-6 30 isFirstAuction toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionNavigation
          isFirstAuction={i % 2 === 0}
  ...
  it('round-7 30 isFirstAuction toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionNavigation
          isFirstAuction={i % 2 === 0}
  ...
  it('round-8 30 isFirstAuction toggle cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionNavigation
          isFirstAuction={i % 2 === 0}
  ...
  it('round-10 30 sequential AuctionNavigation mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionNavigation
          isFirstAuction={false}
