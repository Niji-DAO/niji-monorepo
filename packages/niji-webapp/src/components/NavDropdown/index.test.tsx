...
describe('NavDropDown', () => {
  ...
  it('round-11 30 sequential NavDropDown mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <NavDropDown buttonText={`r11-m-${i}`}>
          <span>x</span>
        </NavDropDown>,
      );
      unmount();
  ...
  it('round-11 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavDropDown key={i} buttonText={`r11-i-${i}`}>
              <span>x</span>
            </NavDropDown>
          ))}
        </>,
  ...
  it('round-11 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(
          <NavDropDown buttonText={`r11-s-${i}`}>
            <span>x</span>
          </NavDropDown>,
        ),
      ).not.toThrow();
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <NavDropDown buttonText={`r11-m2-${i}`}>
          <span>x</span>
        </NavDropDown>,
      );
      unmount();
  ...
  it('round-12 30 sequential NavDropDown mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <NavDropDown buttonText={`r12-m-${i}`}>
          <span>x</span>
        </NavDropDown>,
      );
      unmount();
  ...
  it('round-12 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <NavDropDown key={i} buttonText={`r12-i-${i}`}>
              <span>x</span>
            </NavDropDown>
          ))}
        </>,
  ...
  it('round-12 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(
          <NavDropDown buttonText={`r12-s-${i}`}>
            <span>x</span>
          </NavDropDown>,
        ),
      ).not.toThrow();
  ...
  it('round-12 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <NavDropDown buttonText={`r12-m2-${i}`}>
          <span>x</span>
        </NavDropDown>,
      );
      unmount();
