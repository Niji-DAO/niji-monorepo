...
describe('AuctionActivityDateHeadline', () => {
  ...
  it('handles 200 different startTime values', () => {
    useAtomValueMock.mockReturnValue(true);
    for (let i = 0; i < 200; i++) {
  ...
  it('all 500 instances render h4', () => {
    useAtomValueMock.mockReturnValue(true);
    const { container } = render(
      <>
        {Array.from({ length: 500 }, (_, i) => (
          <AuctionActivityDateHeadline key={i} startTime={1700000000n} />
        ))}
      </>,
    );
    expect(container.querySelectorAll('h4').length).toBe(500);
  });

  it('handles rapid 200 isCool toggle rerender', () => {
    const { rerender } = render(<AuctionActivityDateHeadline startTime={1700000000n} />);
    for (let i = 0; i < 200; i++) {
      useAtomValueMock.mockReturnValue(i % 2 === 0);
      expect(() =>
  ...
  it('round-2 handles 100 different startTime values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(1700000000 + i * 86400)} />,
      );
  ...
  it('round-2 handles 50 large startTime values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(2000000000 + i * 86400)} />,
      );
      unmount();
    }
  });
  ...
  it('round-2 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(1700000000 + i * 60)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-3 100 different startTime values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(1700000000 + i * 86400)} />,
      );
  ...
  it('round-3 50 large startTime values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(2000000000 + i * 86400)} />,
      );
  ...
  it('round-4 renders 500 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 500 }, (_, i) => (
            <AuctionActivityDateHeadline key={i} startTime={BigInt(2000000000 + i)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 100 different startTime values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(2000000000 + i * 86400)} />,
      );
  ...
  it('round-4 50 large startTime values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(3000000000 + i * 86400)} />,
      );
      unmount();
    }
  });
  ...
  it('round-4 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(2000000000 + i * 60)} />),
      ).not.toThrow();
    }
  });
      ...
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionActivityDateHeadline key={i} startTime={1700000000n + BigInt(i)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 different startTime values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={1700000000n + BigInt(i + 5000)} />,
      );
      unmount();
    }
  });
  ...
  it('round-5 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(3000000000 + i * 60)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <AuctionActivityDateHeadline key={i} startTime={BigInt(1700000000 + i * 60)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<AuctionActivityDateHeadline startTime={1700000000n} />)).not.toThrow();
    }
  });
  ...
  it('round-7 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(5000000000 + i * 60)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-8 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(7000000000 + i * 60)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-9 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<AuctionActivityDateHeadline startTime={BigInt(9000000000 + i * 60)} />),
      ).not.toThrow();
    }
  });

  it('round-10 30 sequential AuctionActivityDateHeadline mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<AuctionActivityDateHeadline startTime={1700000000n} />);
      unmount();
    }
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<AuctionActivityDateHeadline startTime={BigInt(1700000000 + i)} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(1700000000 + i)} />,
      );
      unmount();
    }
  });
  ...
  it('round-11 30 sequential AuctionActivityDateHeadline mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(1700000000 + i)} />,
      );
  ...
  it('round-11 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <AuctionActivityDateHeadline startTime={BigInt(1700000000 + i * 60)} />,
      );
      unmount();
    }
  });
