...
describe('TruncatedAmount', () => {
  ...
  it('handles 200 different ETH values', () => {
    for (let i = 0; i < 200; i++) {
      const { container, unmount } = render(<TruncatedAmount amount={parseEther(`${i + 1}`)} />);
      expect(container.textContent).toMatch(/^Ξ \d+\.\d{2}$/);
      unmount();
    }
  });

  it('all 500 instances start with Ξ', () => {
    const { container } = render(
      <>
        {Array.from({ length: 500 }, (_, i) => (
          <TruncatedAmount key={i} amount={parseEther(`${i + 1}`)} />
  ...
  it('handles rerender 200 times with varying amounts', () => {
    const { container, rerender } = render(<TruncatedAmount amount={parseEther('1')} />);
    for (let i = 0; i < 200; i++) {
      rerender(<TruncatedAmount amount={parseEther(`${i + 1}`)} />);
    }
  ...
  it('round-3 100 different amount values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 100) * 10n ** 17n} />);
      unmount();
    }
  ...
  it('round-3 all 200 instances render Ξ prefix', () => {
    const { container } = render(
      <>
        {Array.from({ length: 200 }, (_, i) => (
          <TruncatedAmount key={i} amount={BigInt(i + 1) * 10n ** 18n} />
  ...
  it('round-5 100 different amounts', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 9000) * 10n ** 18n} />);
      unmount();
    }
  });

  it('round-5 50 large amount values', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 200000) * 10n ** 18n} />);
      unmount();
    }
  });
  ...
  it('round-5 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 9500) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-6 30 different amount values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 11000) * 10n ** 18n} />);
      unmount();
    }
  });
  ...
  it('round-6 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 13000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TruncatedAmount key={i} amount={BigInt(i + 15000) * 10n ** 18n} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 17000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TruncatedAmount key={i} amount={BigInt(i + 23000) * 10n ** 18n} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 100 rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 25000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });

  it('round-10 30 sequential TruncatedAmount mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TruncatedAmount amount={parseEther('1')} />);
      unmount();
    }
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<TruncatedAmount amount={parseEther('2')} />)).not.toThrow();
    }
  });

  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 35000) * 10n ** 18n} />);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential rerender cycles second', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 45000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-12 30 sequential TruncatedAmount mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 100000) * 10n ** 18n} />);
      unmount();
    }
  ...
  it('round-12 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <TruncatedAmount key={i} amount={BigInt(i + 110000) * 10n ** 18n} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-12 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<TruncatedAmount amount={BigInt(i + 120000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
  ...
  it('round-12 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<TruncatedAmount amount={BigInt(i + 130000) * 10n ** 18n} />);
      unmount();
    }
  });
  ...
  it('round-12 100 sequential rerender cycles', () => {
    ...
    for (let i = 0; i < 100; i++) {
      expect(() =>
        rerender(<TruncatedAmount amount={BigInt(i + 140000) * 10n ** 18n} />),
      ).not.toThrow();
    }
  });
});
