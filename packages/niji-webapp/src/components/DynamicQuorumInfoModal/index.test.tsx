...
describe('DynamicQuorumInfoModal', () => {
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const p = { ...makeProposal(), id: String(i + 11000) } as never;
            return (
              <DynamicQuorumInfoModal
                key={i}
                proposal={p}
  ...
  it('round-7 30 different proposal mocks', () => {
    for (let i = 0; i < 30; i++) {
      const p = { ...makeProposal(), id: String(i + 13000) } as never;
      const { unmount } = render(
        <DynamicQuorumInfoModal proposal={p} againstVotesAbsolute={5} onDismiss={() => {}} />,
      );
      unmount();
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const p = { ...makeProposal(), id: String(i + 15000) } as never;
            return (
              <DynamicQuorumInfoModal
                key={i}
                proposal={p}
  ...
  it('round-8 30 different proposal mocks', () => {
    for (let i = 0; i < 30; i++) {
      const p = { ...makeProposal(), id: String(i + 17000) } as never;
      const { unmount } = render(
        <DynamicQuorumInfoModal proposal={p} againstVotesAbsolute={5} onDismiss={() => {}} />,
      );
      unmount();
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => {
            const p = { ...makeProposal(), id: String(i + 19000) } as never;
            return (
              <DynamicQuorumInfoModal
                key={i}
                proposal={p}
  ...
  it('round-9 30 different proposal mocks', () => {
    for (let i = 0; i < 30; i++) {
      const p = { ...makeProposal(), id: String(i + 21000) } as never;
      const { unmount } = render(
        <DynamicQuorumInfoModal proposal={p} againstVotesAbsolute={5} onDismiss={() => {}} />,
      );
      unmount();
  ...
  it('round-10 30 sequential DynamicQuorumInfoModal mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DynamicQuorumInfoModal
          proposal={makeProposal() as never}
  ...
  it('round-11 30 sequential DynamicQuorumInfoModal mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DynamicQuorumInfoModal
          proposal={makeProposal()}
          againstVotesAbsolute={i + 50000}
          onDismiss={() => {}}
        />,
      );
      unmount();
