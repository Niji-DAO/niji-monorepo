...
describe('CandidateCard', () => {
  ...
  it('round-3 30 instances rendered together', () => {
    expect(() =>
      wrap(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateCard key={i} candidate={baseCandidate} nounsRequired={i + 1} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-3 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateCard candidate={baseCandidate} nounsRequired={i + 1} />);
      unmount();
    }
  });
  ...
  it('round-4 30 instances rendered together', () => {
    expect(() =>
      wrap(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateCard key={i} candidate={baseCandidate} nounsRequired={i + 100} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-4 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateCard candidate={baseCandidate} nounsRequired={i + 500} />);
      unmount();
    }
  });
  ...
  it('round-5 30 instances rendered together', () => {
    expect(() =>
      wrap(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateCard key={i} candidate={baseCandidate} nounsRequired={3} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-5 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateCard candidate={baseCandidate} nounsRequired={i + 5} />);
      unmount();
    }
  });
  ...
  it('round-6 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(
        <CandidateCard candidate={baseCandidate} nounsRequired={i + 8000} />,
      );
      unmount();
    }
  });
  ...
  it('round-7 30 instances rendered together', () => {
    expect(() =>
      wrap(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateCard key={i} candidate={baseCandidate} nounsRequired={i + 8000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(
        <CandidateCard candidate={baseCandidate} nounsRequired={i + 9000} />,
      );
      unmount();
    }
  });
  ...
  it('round-9 30 instances rendered together', () => {
    expect(() =>
      wrap(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateCard key={i} candidate={baseCandidate} nounsRequired={i + 15000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(
        <CandidateCard candidate={baseCandidate} nounsRequired={i + 17000} />,
      );
      unmount();
    }
  });

  it('round-10 30 sequential CandidateCard mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<CandidateCard candidate={baseCandidate} nounsRequired={i} />);
      unmount();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = wrap(
        <CandidateCard candidate={baseCandidate} nounsRequired={i + 30000} />,
      );
      unmount();
    }
  });

  it('round-10 100 sequential different nounsRequired values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = wrap(
        <CandidateCard candidate={baseCandidate} nounsRequired={i + 40000} />,
      );
      unmount();
    }
  });
