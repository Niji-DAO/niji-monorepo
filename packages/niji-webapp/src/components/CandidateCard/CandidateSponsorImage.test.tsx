...
describe('CandidateSponsorImage', () => {
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsorImage key={i} nounId={BigInt(i + 13000)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-7 50 mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 15000)} />);
      unmount();
    }
  });
  ...
  it('round-7 30 different nounId values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 17000)} />);
      unmount();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsorImage key={i} nounId={BigInt(i + 19000)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 different nounId values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 21000)} />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsorImage key={i} nounId={BigInt(i + 23000)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different nounId values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 25000)} />);
      unmount();
    }
  });

  it('round-10 30 sequential CandidateSponsorImage mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i)} />);
      unmount();
    }
  ...
  it('round-10 30 renders instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsorImage key={i} nounId={BigInt(i + 1)} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<CandidateSponsorImage nounId={BigInt(i + 100)} />)).not.toThrow();
    }
  });

  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 35000)} />);
      unmount();
    }
  });
  ...
  it('round-10 100 sequential different nounId values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(<CandidateSponsorImage nounId={BigInt(i + 45000)} />);
      unmount();
    }
  });
});
