...
describe('CandidateSponsors', () => {
  ...
  it('round-6 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsors signers={[]} nounsRequired={i + 8000} />);
      unmount();
    }
  });
  ...
  it('round-7 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsors key={i} signers={[]} nounsRequired={i + 2} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsors signers={[]} nounsRequired={1} />);
      unmount();
    }
  });
  ...
  it('round-8 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsors key={i} signers={[]} nounsRequired={i + 10000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-8 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() => render(<CandidateSponsors signers={[]} nounsRequired={1} />)).not.toThrow();
    }
  });
  ...
  it('round-8 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsors signers={[]} nounsRequired={i + 12000} />);
      unmount();
    }
  });
  ...
  it('round-9 renders 30 instances variant', () => {
    expect(() =>
      render(
        <>
          {Array.from({ length: 30 }, (_, i) => (
            <CandidateSponsors key={i} signers={[]} nounsRequired={i + 14000} />
          ))}
        </>,
      ),
    ).not.toThrow();
  ...
  it('round-9 30 different nounsRequired values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(<CandidateSponsors signers={[]} nounsRequired={i + 16000} />);
      unmount();
    }
  });
