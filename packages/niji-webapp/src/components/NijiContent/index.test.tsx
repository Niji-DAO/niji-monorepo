...
describe('NijiContent', () => {
  ...
  it('round-251 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-252 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-253 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-254 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-255 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-256 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-257 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-258 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
  ...
  it('round-259 30 sequential NijiContent mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = wrap(<NijiContent {...defaults} />);
      unmount();
    }
