...
describe('DelegationCandidateInfo', () => {
  ...
  it('renders 50 DelegationCandidateInfo instances independently', () => {
    expect(() =>
      render(
        <>
  ...
  it('handles 200 consecutive renders without crash', () => {
    for (let i = 0; i < 200; i++) {
      expect(() =>
        render(
          <DelegationCandidateInfo
  ...
  it('rerender 30 times with state transitions', () => {
    const { rerender } = render(
      <DelegationCandidateInfo address="0xA" changeModalState={0 as never} votesToAdd={0} />,
    );
    for (let i = 0; i < 30; i++) {
  ...
  it('handles negative votesToAdd values', () => {
    [-1, -10, -1000].forEach(vt => {
      expect(() =>
        render(
          <DelegationCandidateInfo address="0xA" changeModalState={0 as never} votesToAdd={vt} />,
        ),
      ).not.toThrow();
    });
  });

  it('renders for empty + very long addresses', () => {
    ['', '0x', '0x' + 'a'.repeat(1000)].forEach(addr => {
      expect(() =>
        render(
          <DelegationCandidateInfo address={addr} changeModalState={0 as never} votesToAdd={1} />,
        ),
      ).not.toThrow();
    });
  });
  ...
  it('round-2 handles 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
  ...
  it('round-4 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={i + 500} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-6 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={i + 9000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-7 mount-unmount 30 cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={1} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-7 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<DelegationCandidateInfo address="0xABC" votesToAdd={1} userDelegatee="0xUSER" />),
      ).not.toThrow();
    }
  });
  ...
  it('round-7 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={i + 13000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-8 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={i + 17000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-9 30 different votesToAdd values', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xABC" votesToAdd={i + 21000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });

  it('round-10 30 sequential DelegationCandidateInfo mount-unmount cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xR10" votesToAdd={i} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
  ...
  it('round-10 30 sequential renders without crash', () => {
    for (let i = 0; i < 30; i++) {
      expect(() =>
        render(<DelegationCandidateInfo address="0xR10" votesToAdd={i} userDelegatee="0xUSER" />),
      ).not.toThrow();
    }
  });
  ...
  it('round-10 50 sequential mount-unmount cycles second', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xR10-2" votesToAdd={i + 30000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });

  it('round-10 100 sequential different votesToAdd values', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = render(
        <DelegationCandidateInfo address="0xR10" votesToAdd={i + 40000} userDelegatee="0xUSER" />,
      );
      unmount();
    }
  });
