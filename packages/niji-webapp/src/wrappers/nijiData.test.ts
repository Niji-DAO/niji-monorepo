...
describe('useProposalFeedback', () => {
  ...
  it('round-5 30 renderHook cycles useCreateProposalCandidate', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useCreateProposalCandidate());
      unmount();
    }
  ...
  it('round-5 30 renderHook cycles useCancelCandidate', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useCancelCandidate());
      unmount();
    }
  ...
  it('round-5 100 sequential useCreateProposalCandidate cycles', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = renderHook(() => useCreateProposalCandidate());
      unmount();
    }
  ...
  it('round-8 30 sequential useCreateProposalCandidate access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useCreateProposalCandidate).toBeDefined();
    }
  });
  ...
  it('round-8 30 renderHook cycles', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useCreateProposalCandidate());
      unmount();
    }
  ...
  it('round-8 100 sequential useCreateProposalCandidate cycles', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = renderHook(() => useCreateProposalCandidate());
      unmount();
    }
  ...
  it('round-10 30 sequential useCreateProposalCandidate renderHook', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useCreateProposalCandidate());
      unmount();
    }
  ...
  it('round-11 30 sequential useCreateProposalCandidate truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useCreateProposalCandidate).toBeTruthy();
    }
  });
