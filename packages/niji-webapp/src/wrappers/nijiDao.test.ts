...
describe('useForkThreshold / useNumTokensInForkEscrow / useAdjustedTotalSupply', () => {
  ...
  it('round-5 30 renderHook cycles useProposalCount', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useProposalCount());
      unmount();
    }
  ...
  it('round-5 30 renderHook cycles useProposalThreshold', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useProposalThreshold());
      unmount();
    }
  ...
  it('round-5 50 alternating cycles', () => {
    for (let i = 0; i < 50; i++) {
      const { unmount } =
        i % 2 === 0
          ? renderHook(() => useProposalCount())
  ...
  it('round-5 50 useProposalCount type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useProposalCount).toBe('function');
    }
  });

  it('round-5 50 useProposalThreshold type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });
  ...
  it('round-7 30 renderHook cycles useProposalCount', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useProposalCount());
      unmount();
    }
  ...
  it('round-7 100 sequential reference consistency', () => {
    const first = useProposalCount;
    for (let i = 0; i < 100; i++) {
      expect(useProposalCount).toBe(first);
    }
  });

  it('round-7 50 sequential truthy checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(useProposalCount).toBeTruthy();
    }
  });

  it('round-7 50 useProposalThreshold type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });

  it('round-8 30 sequential useProposalThreshold access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalThreshold).toBeDefined();
    }
  });
  ...
  it('round-8 100 sequential reference consistency', () => {
    const first = useProposalThreshold;
    for (let i = 0; i < 100; i++) {
      expect(useProposalThreshold).toBe(first);
    }
  });
  ...
  it('round-8 50 useProposalThreshold type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });

  it('round-9 30 sequential useProposalThreshold access', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalThreshold).toBeDefined();
    }
  });

  it('round-9 50 useProposalThreshold type checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });

  it('round-9 100 useProposalThreshold reference consistency', () => {
    const first = useProposalThreshold;
    for (let i = 0; i < 100; i++) {
      expect(useProposalThreshold).toBe(first);
    }
  ...
  it('round-9 50 useProposalThreshold truthy checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(useProposalThreshold).toBeTruthy();
    }
  });

  it('round-9 100 useProposalThreshold type checks second', () => {
    for (let i = 0; i < 100; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });

  it('round-10 30 useProposalThreshold renderHook', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useProposalThreshold());
      unmount();
    }
  ...
  it('round-10 30 useProposalThreshold truthiness checks', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalThreshold).toBeTruthy();
    }
  });
  ...
  it('round-11 30 sequential useProposalThreshold truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useProposalThreshold).toBeTruthy();
    }
  });
  ...
  it('round-11 100 sequential type checks fourth', () => {
    for (let i = 0; i < 100; i++) {
      expect(typeof useProposalThreshold).toBe('function');
    }
  });
