...
describe('useOnDisplayAuction additional cases', () => {
  ...
  it('round-9 30 sequential useOnDisplayAuction renderHook', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useOnDisplayAuction());
      unmount();
    }
  ...
  it('round-9 30 sequential useAuctionBids renderHook', () => {
    for (let i = 0; i < 30; i++) {
      const { unmount } = renderHook(() => useAuctionBids(BigInt(i)));
      unmount();
    }
  ...
  it('round-9 30 sequential type checks useOnDisplayAuction', () => {
    for (let i = 0; i < 30; i++) {
      expect(typeof useOnDisplayAuction).toBe('function');
    }
  });

  it('round-9 50 sequential type checks useAuctionBids', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useAuctionBids).toBe('function');
    }
  });

  it('round-9 100 sequential combined renderHook', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } =
        i % 2 === 0
          ? renderHook(() => useOnDisplayAuction())
          : renderHook(() => useAuctionBids(BigInt(i + 1000)));
      unmount();
    }
  });

  it('round-10 30 useOnDisplayAuction truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useOnDisplayAuction).toBeTruthy();
    }
  });

  it('round-10 30 useAuctionBids truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useAuctionBids).toBeTruthy();
    }
  });

  it('round-10 30 useOnDisplayAuction defined checks', () => {
    for (let i = 0; i < 30; i++) {
      expect(useOnDisplayAuction).toBeDefined();
    }
  });

  it('round-10 50 sequential type checks combined', () => {
    for (let i = 0; i < 50; i++) {
      expect(typeof useOnDisplayAuction).toBe('function');
      expect(typeof useAuctionBids).toBe('function');
    }
  ...
  it('round-10 100 sequential renderHook second', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = renderHook(() => useOnDisplayAuction());
      unmount();
    }
  ...
  it('round-11 30 useOnDisplayAuction truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useOnDisplayAuction).toBeTruthy();
    }
  });

  it('round-11 30 useAuctionBids truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(useAuctionBids).toBeTruthy();
    }
  });
  ...
  it('round-11 50 sequential combined defined', () => {
    for (let i = 0; i < 50; i++) {
      expect(useOnDisplayAuction).toBeDefined();
      expect(useAuctionBids).toBeDefined();
    }
  });

  it('round-11 100 sequential renderHook second', () => {
    for (let i = 0; i < 100; i++) {
      const { unmount } = renderHook(() => useOnDisplayAuction());
      unmount();
    }
