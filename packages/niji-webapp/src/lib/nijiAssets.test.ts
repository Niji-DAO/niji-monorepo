...
describe('nijiTraitKeys', () => {
  ...
  it('round-7 30 sequential humanizeTraitKey access', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-7 100 sequential reference consistency', () => {
    const first = humanizeTraitKey;
    for (let i = 0; i < 100; i++) {
      expect(humanizeTraitKey).toBe(first);
    }
  });
  ...
  it('round-7 30 various trait values', () => {
    const keys = ['background', 'body', 'head', 'glasses', 'accessory'];
    for (let i = 0; i < 30; i++) {
      expect(() => humanizeTraitKey(keys[i % 5])).not.toThrow();
    }
  ...
  it('round-8 30 sequential humanizeTraitKey access', () => {
    for (let i = 0; i < 30; i++) {
      expect(humanizeTraitKey).toBeDefined();
    }
  });
  ...
  it('round-8 30 various trait values', () => {
    const keys = ['background', 'body', 'head', 'glasses', 'accessory'];
    for (let i = 0; i < 30; i++) {
      expect(() => humanizeTraitKey(keys[i % 5])).not.toThrow();
    }
  ...
  it('round-9 30 sequential humanizeTraitKey access', () => {
    for (let i = 0; i < 30; i++) {
      expect(humanizeTraitKey).toBeDefined();
    }
  });
  ...
  it('round-9 50 nijiTraitKeys truthy checks', () => {
    for (let i = 0; i < 50; i++) {
      expect(nijiTraitKeys).toBeTruthy();
    }
  });

  it('round-9 30 various trait values', () => {
    const keys = ['background', 'body', 'head', 'glasses', 'accessory'];
    for (let i = 0; i < 30; i++) {
      expect(() => humanizeTraitKey(keys[i % 5])).not.toThrow();
    }
  ...
  it('round-10 30 sequential humanizeTraitKey truthiness', () => {
    for (let i = 0; i < 30; i++) {
  ...
  it('round-10 30 nijiTraitKeys truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(nijiTraitKeys).toBeTruthy();
    }
  });
  ...
  it('round-10 100 sequential invocations second', () => {
    const keys = ['background', 'body', 'head', 'glasses', 'accessory'];
    for (let i = 0; i < 100; i++) {
      expect(() => humanizeTraitKey(keys[i % 5])).not.toThrow();
    }
