...
describe('execute', () => {
  ...
  it('round-7 30 sequential execute access', () => {
    for (let i = 0; i < 30; i++) {
      expect(execute).toBeDefined();
    }
  });
  ...
  it('round-7 50 sequential truthiness check second', () => {
    for (let i = 0; i < 50; i++) {
      expect(execute).toBeTruthy();
    }
  });

  it('round-8 30 sequential execute access', () => {
    for (let i = 0; i < 30; i++) {
      expect(execute).toBeDefined();
    }
  });
  ...
  it('round-8 50 sequential truthiness check second', () => {
    for (let i = 0; i < 50; i++) {
      expect(execute).toBeTruthy();
    }
  });
  ...
  it('round-10 30 sequential execute truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(execute).toBeTruthy();
    }
  });
  ...
  it('round-11 30 sequential execute truthiness', () => {
    for (let i = 0; i < 30; i++) {
      expect(execute).toBeTruthy();
    }
  });
