...
export type GetProposalQuery = {
  ...
  proposal?: {
    ...
    targets?: Array<'Byte'> | null;
    values?: Array<bigint> | null;
    signatures?: Array<string> | null;
    calldatas?: Array<'Byte'> | null;
    onTimelockV1?: boolean | null;
    voteSnapshotBlock: bigint;
    proposer: { __typename?: 'Delegate'; id: string };
    signers?: Array<{ __typename?: 'Delegate'; id: string }> | null;
  } | null;
};
...
export type GetActivePendingUpdatableProposersQuery = {
  __typename?: 'Query';
  proposals: Array<{
    __typename?: 'Proposal';
    proposer: { __typename?: 'Delegate'; id: string };
...
export type GetUpdatableProposalsQuery = {
  __typename?: 'Query';
...
export type GetCandidateProposalsQuery = {
  __typename?: 'Query';
  proposalCandidates: Array<{
    ...
    versions: Array<{
      __typename?: 'ProposalCandidateVersion';
      content: { __typename?: 'ProposalCandidateContent'; title: string };
    }>;
    latestVersion: {
      __typename?: 'ProposalCandidateVersion';
      content: {
        ...
        signatures?: Array<string> | null;
        calldatas?: Array<'Byte'> | null;
        encodedProposalHash: 'Byte';
        proposalIdToUpdate: bigint;
        matchingProposalIds?: Array<bigint> | null;
...
export type GetCandidateProposalVersionsQuery = {
  __typename?: 'Query';
  proposalCandidate?: {
    __typename?: 'ProposalCandidate';
    id: string;
    ...
    latestVersion: { __typename?: 'ProposalCandidateVersion'; id: string };
  } | null;
};
...
export type GetProposalVersionsQuery = {
  __typename?: 'Query';
...
export type GetAuctionQuery = {
  ...
  auction?: {
    ...
    startTime: bigint;
    endTime: bigint;
    bidder?: { __typename?: 'Account'; id: string } | null;
    noun: {
      __typename?: 'Noun';
      id: string;
      seed?: {
...
export type GetBidsByAuctionQuery = {
  __typename?: 'Query';
  bids: Array<{
    __typename?: 'Bid';
    id: string;
    ...
    txIndex: bigint;
    bidder?: { __typename?: 'Account'; id: string } | null;
    noun: { __typename?: 'Noun'; id: string };
  }>;
};
...
export type GetNounsIndexQuery = {
  __typename?: 'Query';
  nouns: Array<{ __typename?: 'Noun'; id: string; owner: { __typename?: 'Account'; id: string } }>;
};
...
export type GetLatestAuctionsQuery = {
  __typename?: 'Query';
  auctions: Array<{
    __typename?: 'Auction';
    id: string;
    ...
    endTime: bigint;
    bidder?: { __typename?: 'Account'; id: string } | null;
    noun: { __typename?: 'Noun'; id: string; owner: { __typename?: 'Account'; id: string } };
    bids: Array<{
      __typename?: 'Bid';
      id: string;
      amount: bigint;
...
export type GetLatestBidsQuery = {
  __typename?: 'Query';
  bids: Array<{
    __typename?: 'Bid';
    id: string;
...
export type GetNounVotingHistoryQuery = {
  __typename?: 'Query';
  noun?: {
    __typename?: 'Noun';
    id: string;
...
export type GetNounTransferHistoryQuery = {
  __typename?: 'Query';
  transferEvents: Array<{
    __typename?: 'TransferEvent';
    id: string;
    blockNumber: bigint;
    previousHolder: { __typename?: 'Account'; id: string };
    newHolder: { __typename?: 'Account'; id: string };
  }>;
};
...
export type GetNounDelegationHistoryQuery = {
  __typename?: 'Query';
  delegationEvents: Array<{
    __typename?: 'DelegationEvent';
    id: string;
    blockNumber: bigint;
    previousDelegate: { __typename?: 'Delegate'; id: string };
    newDelegate: { __typename?: 'Delegate'; id: string };
  }>;
};

export type GetCreateTimestampAllProposalsQueryVariables = Exact<{ [key: string]: never }>;

export type GetCreateTimestampAllProposalsQuery = {
  __typename?: 'Query';
  proposals: Array<{ __typename?: 'Proposal'; id: string; createdTimestamp: bigint }>;
};
...
export type GetDelegateNounsAtBlockQuery = {
  __typename?: 'Query';
  delegates: Array<{
    __typename?: 'Delegate';
    id: string;
...
export type GetCurrentlyDelegatedNounsQuery = {
  __typename?: 'Query';
  delegates: Array<{
    __typename?: 'Delegate';
    id: string;
...
export type GetAdjustedNounSupplyAtPropSnapshotQuery = {
  __typename?: 'Query';
  proposals: Array<{ __typename?: 'Proposal'; adjustedTotalSupply: bigint }>;
};
...
export type GetPropUsingDynamicQuorumQuery = {
  __typename?: 'Query';
  proposal?: { __typename?: 'Proposal'; quorumCoefficient: bigint } | null;
};
...
export type GetProposalFeedbacksQuery = {
  __typename?: 'Query';
...
export type GetCandidateFeedbacksQuery = {
  __typename?: 'Query';
  candidateFeedbacks: Array<{
    ...
    createdTimestamp: bigint;
    voter: { __typename?: 'Delegate'; id: string };
    candidate: { __typename?: 'ProposalCandidate'; id: string };
  }>;
};
...
export type GetOwnedNounsQuery = {
  __typename?: 'Query';
  nouns: Array<{ __typename?: 'Noun'; id: string }>;
};
...
export type GetAccountEscrowedNounsQuery = {
  __typename?: 'Query';
  escrowedNouns: Array<{
    __typename?: 'EscrowedNoun';
    noun: { __typename?: 'Noun'; id: string };
    fork: { __typename?: 'Fork'; id: string };
  }>;
};
...
export type GetEscrowDepositEventsQuery = {
  __typename?: 'Query';
  escrowDeposits: Array<{
    __typename?: 'EscrowDeposit';
    id: string;
    createdAt: bigint;
    reason?: string | null;
    ...
    owner: { __typename?: 'Delegate'; id: string };
  }>;
};
...
export type GetEscrowWithdrawEventsQuery = {
  __typename?: 'Query';
  escrowWithdrawals: Array<{
    __typename?: 'EscrowWithdrawal';
    id: string;
    createdAt: bigint;
    tokenIDs: Array<bigint>;
...
export type GetForkDetailsQuery = {
  __typename?: 'Query';
  fork?: {
    __typename?: 'Fork';
    id: string;
    ...
    forkTreasury?: 'Byte' | null;
    forkToken?: 'Byte' | null;
    tokensForkingCount: number;
    tokensInEscrowCount: number;
    forkingPeriodEndTimestamp?: bigint | null;
    escrowedNouns: Array<{
      __typename?: 'EscrowedNoun';
      noun: { __typename?: 'Noun'; id: string };
    }>;
...
export type GetIsForkActiveQuery = {
  __typename?: 'Query';
  forks: Array<{ __typename?: 'Fork'; forkID: bigint; forkingPeriodEndTimestamp?: bigint | null }>;
};
...
export const GetPartialProposalsDocument = new TypedDocumentString(`
  ...
  GetPartialProposalsQueryVariables
>;
export const GetActivePendingUpdatableProposersDocument = new TypedDocumentString(`
  ...
  proposals(
    ...
    `) as unknown as TypedDocumentString<
  GetActivePendingUpdatableProposersQuery,
  GetActivePendingUpdatableProposersQueryVariables
>;
...
export const GetCandidateProposalsDocument = new TypedDocumentString(`
  ...
  GetCandidateProposalsQueryVariables
>;
...
export const GetCandidateProposalVersionsDocument = new TypedDocumentString(`
  ...
  GetCandidateProposalVersionsQueryVariables
>;
...
export const GetNounVotingHistoryDocument = new TypedDocumentString(`
  ...
  noun(id: $nounId) {
    ...
    `) as unknown as TypedDocumentString<
  GetNounVotingHistoryQuery,
  GetNounVotingHistoryQueryVariables
>;
export const GetNounTransferHistoryDocument = new TypedDocumentString(`
  ...
  transferEvents(where: {noun: $nounId}, first: $first) {
    ...
    `) as unknown as TypedDocumentString<
  GetNounTransferHistoryQuery,
  GetNounTransferHistoryQueryVariables
>;
...
export const GetCreateTimestampAllProposalsDocument = new TypedDocumentString(`
  ...
  proposals(orderBy: createdTimestamp, orderDirection: asc, first: 1000) {
    ...
    `) as unknown as TypedDocumentString<
  GetCreateTimestampAllProposalsQuery,
  GetCreateTimestampAllProposalsQueryVariables
>;
...
export const GetDelegateNounsAtBlockDocument = new TypedDocumentString(`
  ...
  GetDelegateNounsAtBlockQueryVariables
>;
export const GetCurrentlyDelegatedNounsDocument = new TypedDocumentString(`
  ...
  delegates(where: {id: $delegate}) {
    ...
    `) as unknown as TypedDocumentString<
  GetCurrentlyDelegatedNounsQuery,
  GetCurrentlyDelegatedNounsQueryVariables
>;
export const GetAdjustedNounSupplyAtPropSnapshotDocument = new TypedDocumentString(`
  ...
  proposals(where: {id: $proposalId}) {
    ...
    `) as unknown as TypedDocumentString<
  GetAdjustedNounSupplyAtPropSnapshotQuery,
  GetAdjustedNounSupplyAtPropSnapshotQueryVariables
>;
export const GetPropUsingDynamicQuorumDocument = new TypedDocumentString(`
  ...
  proposal(id: $proposalId) {
    ...
    `) as unknown as TypedDocumentString<
  GetPropUsingDynamicQuorumQuery,
  GetPropUsingDynamicQuorumQueryVariables
>;
export const GetProposalFeedbacksDocument = new TypedDocumentString(`
  ...
  proposalFeedbacks(where: {proposal_: {id: $proposalId}}) {
    ...
    `) as unknown as TypedDocumentString<
  GetProposalFeedbacksQuery,
  GetProposalFeedbacksQueryVariables
>;
export const GetCandidateFeedbacksDocument = new TypedDocumentString(`
  ...
  candidateFeedbacks(where: {candidate_: {id: $candidateId}}) {
    ...
    `) as unknown as TypedDocumentString<
  GetCandidateFeedbacksQuery,
  GetCandidateFeedbacksQueryVariables
>;
...
export const GetEscrowDepositEventsDocument = new TypedDocumentString(`
  ...
  escrowDeposits(where: {fork: $forkId, tokenIDs_not: []}, first: 1000) {
    ...
    `) as unknown as TypedDocumentString<
  GetEscrowDepositEventsQuery,
  GetEscrowDepositEventsQueryVariables
>;
...
export const GetEscrowWithdrawEventsDocument = new TypedDocumentString(`
  ...
  escrowWithdrawals(where: {fork: $forkId, tokenIDs_not: []}, first: 1000) {
    ...
    `) as unknown as TypedDocumentString<
  GetEscrowWithdrawEventsQuery,
  GetEscrowWithdrawEventsQueryVariables
>;
